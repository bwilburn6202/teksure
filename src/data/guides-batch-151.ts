...
export const guidesBatch151: Guide[] = [
  {
    ...
    excerpt: 'Self-checkout can save you time, but the machines can be confusing. This guide walks you through every step — scanning, weighing, paying, and getting help.',
...
Sources: How-To Geek, AARP, individual grocery chain help pages (Walmart, Kroger, Target).`,
    steps: [
      {
        ...
        content: 'Walk up to an open self-checkout station. The screen will say something like "Touch to Begin" or "Start Here." Tap the screen to start. If the store has a loyalty card or phone number program (like Kroger Plus or Safeway Club), the screen will ask for it now — enter your phone number or scan your card to get your member discounts.',
      ...
      },
      {
        ...
        warning: 'If the machine displays "Attendant Has Been Notified" and freezes, wait — an attendant is on the way. Do not walk away from an incomplete transaction.',
      },
      {
        title: 'Ask for help anytime',
        content: 'Every self-checkout area has at least one store employee — sometimes called a self-checkout host — standing nearby. They can override error messages, apply paper coupons, check that your loyalty discounts went through, and help with anything the machine could not handle. There is no limit on how much you can ask for help. Tap "Call Attendant" on the screen at any time, or make eye contact with the employee nearby and wave them over.',
      },
    ],
  },

  {
    ...
    excerpt: 'Robocalls and spam calls target millions of Americans every day. Learn how to screen calls, report them to the FTC, and use free tools to block them.',
...
Current Samsung Galaxy phones include a call protect feature built into the Samsung Phone app. You can turn it on under Phone app > Settings > Call Protect.
    ...
    steps: [
      {
        ...
        content: 'If your phone rings and you do not recognize the number, do not pick up. Let it ring through to voicemail. Legitimate callers — doctors, pharmacies, family members calling from a new number — will leave a message. Scammers almost never leave a genuine voicemail. After the call ends, check whether a message was left before deciding to call back.',
...
Sources: AARP, Consumer Cellular website, Tracfone website, FCC Consumer Guides (fcc.gov), Tom's Guide.`,
    steps: [
      ...
      },
      {
        ...
        content: 'On the back of a physical minutes card, there is a silver scratch-off panel covering a long number called a PIN (Personal Identification Number). Use a coin to gently scratch it off, the same way you would scratch a lottery ticket. Write down the PIN on a piece of paper before you enter it anywhere — if you make a typo online or get disconnected during a call, you will need the number again.',
        warning: 'Never buy a minutes card if the scratch-off panel looks like it has already been scratched. This is a common scam — someone scratches the PIN in the store, writes it down, and then you buy a card with no usable value on it.',
      },
      {
        title: 'Add the minutes to your account',
        content: 'Go to your carrier\'s website on a phone or computer and log in (or create a free account if this is your first time). Look for a link that says "Add Airtime," "Add Minutes," or "Refill." Enter the PIN from your card when prompted. The minutes will be added to your account right away. Alternatively, call your carrier\'s toll-free number (printed on the card and in your paperwork) and a representative will add the minutes for you over the phone.',
...

  {
    ...
    excerpt: 'Windows has built-in tools to make text larger, read content aloud, and boost contrast — no extra software needed. Works on Windows 10 and Windows 11.',
    ...
    steps: [
      {
        ...
        content: 'Press and hold the Windows key (the key with the four-square Windows logo, usually in the bottom-left of your keyboard) and press the Plus sign (+) at the same time. The screen will zoom in. Press Windows + Plus again to zoom in further. Press Windows + Minus (-) to zoom out. Press Windows + Escape to close Magnifier and return to your normal view. You can adjust how much the screen zooms each press by opening the Magnifier app window and changing the zoom increment from 100% to a smaller number like 25% or 50%.',
      ...
      },
      {
        ...
        warning: 'Narrator reads everything on the screen, including dialog boxes and notifications. If it becomes overwhelming, press Windows + Ctrl + Enter to turn it off at any time.',
      },
      {
      ...
      },
      {
        ...
        content: 'All four of the tools covered in this guide — Magnifier, Narrator, High Contrast, and mouse pointer size — are in the same area of Windows Settings. Press Windows key + I to open Settings. In Windows 11, click "Accessibility" in the left column. In Windows 10, click "Ease of Access." From there you will see every accessibility option organized by category: Vision, Hearing, and Interaction. Browse through to find additional options like making text larger across the whole system (under "Text size") without zooming the entire screen.',
