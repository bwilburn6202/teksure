...
export const guidesBatch320: Guide[] = [
  ...
  },
  {
    ...
    body: "Every year, Medicare's open enrollment period runs from October 15 to December 7. During that window you can switch Medicare Advantage plans, move between Original Medicare and Medicare Advantage, or change your Part D prescription drug plan for the coming year.\n\nPlans and their costs change every year. The plan that was cheapest last year may not be the best fit now. The official Medicare Plan Finder at medicare.gov is the government's free, unbiased way to compare every plan in your area side by side.\n\nThe tool lets you enter the medications you take. It then calculates what each plan would actually cost you for the year, instead of just comparing monthly premiums. This matters: a plan with a low premium can cost more overall if it does not cover a drug you take regularly.\n\nBe careful about unsolicited phone calls or door-to-door visitors during this period who claim to represent Medicare. Medicare does not call or visit uninvited to sell you a plan. Licensed insurance agents can genuinely help, but verify a caller's identity yourself before sharing any personal information. Source: medicare.gov/plan-compare.",
    steps: [
      {
