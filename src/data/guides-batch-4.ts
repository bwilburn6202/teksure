...
If you have children or grandchildren in college or living on their own who need Netflix, the most cost-effective solution is usually for them to start their own Netflix account. Netflix often has promotions for new subscribers. If you are the one whose access was cut off, you can set up your own account quickly at Netflix.com — choose a plan (the Standard with Ads plan is the most affordable) and enter a payment method. Your watch history and preferences can also be transferred to a new account using the Netflix data transfer feature found in your account settings.`,
    steps: [
    ...
    steps: [
      {
        ...
        warning: 'Do not press the small "Reset" button on the router — that erases all your settings and requires starting over. Unplug the power cord.',
      },
      {
