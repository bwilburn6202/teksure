...
export const guidesBatch19: Guide[] = [
  {
    ...
    excerpt: 'Wireless charging lets you power up your phone by setting it on a pad — no cable plugging required. Here is what you need and how to use it.',
...

  {
    ...
    excerpt: 'Bluetooth trackers like Tile and Apple AirTag attach to keys, wallets, and bags so you can locate them using your phone when they go missing.',
    category: 'tips-tricks',
...

  {
    ...
    excerpt: 'Google, Facebook, and banks send alerts when someone logs into your account from a new device. Here is how to tell if it was you — and what to do if it was not.',
    ...
    steps: [
      ...
      },
      {
        ...
        warning: "A genuine suspicious login alert from a legitimate company will never ask for your password or payment information. If an alert email asks for your password or a fee to \"restore\" your account, it is a phishing scam.",
      },
      {
        title: 'Prevent future unauthorized access',
        content: "After securing your account: turn on two-factor authentication (requires a code from your phone for any new login). Use a unique password for this account — never reuse passwords across multiple sites. Consider a password manager (like Bitwarden, free) to generate and store strong unique passwords. Set up account activity alerts so you are notified of future logins. Check if your email address was in a data breach at haveibeenpwned.com — a free, safe service that tells you if your email appeared in known breaches.",
      },
    ],
  },

  {
    ...
    excerpt: 'Payment apps are convenient but attract scammers. Learn the most common tricks used on Venmo, Cash App, and Zelle — and how to stay protected.',
    category: 'safety-guides',
...

  {
    ...
    excerpt: 'If the text on your Android phone is too small to read comfortably, a few settings changes can make everything larger — no glasses required.',
    category: 'tips-tricks',
    ...
    steps: [
      {
        ...
        content: "On Google Pixel and many Android phones running Android 14 or later: press a volume button on the side of your phone → a small caption icon (a box with lines representing text) appears below the volume slider. Tap it to turn on Live Caption. A caption bar appears at the bottom of your screen transcribing any audio playing. This works for videos, podcast, voice messages, and even phone calls. To access through settings: Settings → Accessibility → Live Caption → toggle ON.",
      ...
      },
      {
        ...
        content: "For traditional landline phones: Caption Call and CaptionCall are free services (funded by the FCC) for people with hearing loss. You get a special phone with a screen that displays real-time captions of every call. CapTel phones are similar. These require a broadband internet connection but are completely free for qualifying users. Apply at captionedtelephone.com. The service includes a free captioned phone and professional setup.",
      },
    ],
  },
...

  {
    ...
    excerpt: 'Scanning receipts with your phone camera creates digital copies for warranties, expense tracking, or taxes — no scanner or fax machine required.',
    category: 'tips-tricks',
    ...
    steps: [
      {
        ...
        content: "Open the Notes app → tap the + button to create a new note → tap the camera icon at the bottom → \"Scan Documents.\" Hold your phone over the receipt. The camera automatically detects the document edges and captures the scan when the image is sharp. Multiple receipts can be scanned into a single note. Tap \"Save\" to save the scanned receipt as a PDF in the note. Rename the note with the store name and date for easy searching later.",
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "For items worth more than $100, take individual photos: one clear photo of the item from the front, one showing the brand label or serial number, and one showing any notable features or damage. Take a photo of the receipt or original packaging if you have them. For jewelry: photograph with a ruler or coin for scale. Store photos organized by room or category in a dedicated album in your Photos app called \"Home Inventory.\"",
      },
      {
...

  {
    ...
    excerpt: 'In an emergency, having important information saved digitally — on your phone and in the cloud — can be critical. Here is what to document and where to keep it.',
    category: 'safety-guides',
...

  {
    ...
    excerpt: `MagSafe is Apple's magnetic charging system for iPhone 12 and later. It snaps into place automatically and charges faster than standard wireless charging.`,
...

  {
    ...
    excerpt: "Apple Watch can take an ECG reading and detect irregular heart rhythms. Here's how to use these health monitoring features and what to do with the results.",
...

  {
    ...
    excerpt: "Your phone can translate signs, menus, printed text, and spoken conversations in real time — no dictionary or translator needed. Here's how.",
    category: 'tips-tricks',
...

  {
    ...
    excerpt: 'Many streaming services, apps, phone plans, and tech subscriptions offer discounts for people 55 and older — but you have to ask. Here is where to look.',
    category: 'life-transitions',
...

  {
    ...
    excerpt: "Google Photos automatically creates memory slideshows of past photos — here's how to find them, personalize what appears, and share them with family.",
    category: 'app-guides',
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "To make ETA sharing faster with people you often drive to or from: add them as a Favorite contact in Maps. Open Maps → tap your profile picture → \"Favorites\" → tap + → add a contact and label them \"Family.\" When you share your ETA next time, these favorites appear at the top of the contact list. You can also add your home and work addresses as Favorites for fast navigation to common destinations.",
      },
    ],
  },

  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Depending on the fraud type: Medicare fraud — report to the HHS OIG hotline at 1-800-HHS-TIPS. Social Security fraud — report to the Social Security OIG at 1-800-269-0271 or oig.ssa.gov. Investment fraud — report to the SEC at sec.gov/tcr. Mail fraud — report to the US Postal Inspection Service at postalinspectors.uspis.gov. State-level: also report to your state attorney general's consumer protection division — many states have active elder fraud units that investigate local cases. Search your state's name plus \"consumer protection\" or \"elder fraud\" to find the right number.",
      },
    ],
  },

  {
    ...
    excerpt: "Windows 11's Dark Mode reduces eye strain in low light, and Night Light warms screen colors in the evening to help you sleep better. Here's how to turn both on.",
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Apple's iCloud Keychain stores and syncs passwords across all your Apple devices. To share a stored password with a family member: go to Settings → Passwords → find the website or app password → tap \"Share\" → choose who to share it with. The recipient needs an iPhone and must have iCloud Keychain enabled (Settings → your name → iCloud → Passwords and Keychain → ON). Shared passwords stay encrypted — you are sharing access to the password through Apple's secure system, not sending the password as readable text.",
      },
      {
        title: 'Use a password manager for families with mixed devices',
        content: "If your family uses a mix of iPhone and Android, a cross-platform password manager is the best solution. **Bitwarden** (free) is highly recommended: it works on iPhone, Android, Mac, Windows, and all browsers. Create a free account, add passwords to your vault, and invite family members to a shared collection. Everyone accesses the same passwords from their own devices. Passwords are end-to-end encrypted — not even Bitwarden's servers can read them.",
...

  {
    ...
    excerpt: 'Siri lets you make calls, send texts, get directions, and play music while keeping both hands on the wheel. Here is how to set it up and use it safely.',
    category: 'phone-guides',
