...
export const guidesBatch18: Guide[] = [
  {
    ...
    excerpt: 'A Zoom virtual background replaces or blurs what is behind you during video calls — no messy room visible, just you. Here is how to set one up.',
...

  {
    ...
    excerpt: 'Gmail, Outlook, and Apple Mail all let you undo a sent email within a short window. Here is how to enable the feature and use it before it is too late.',
    category: 'essential-skills',
...

  {
    ...
    excerpt: "If you get a new iPhone or need to reset your current one, restoring from an iCloud backup brings back all your apps, photos, and settings. Here's how.",
...

  {
    ...
    excerpt: "Samsung Health is a free app on Samsung phones that tracks steps, heart rate, sleep, and more — no separate device required. Here's how to use it.",
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Tap \"Track\" or \"Workout\" to log exercise. Choose from dozens of activity types: walking, running, cycling, swimming, yoga, strength training, and more. Tap the activity → \"Start.\" Samsung Health records duration, heart rate (if your phone or watch has the sensor), estimated calories burned, and maps your route (for outdoor activities with location enabled). When done, tap \"Stop\" to save the workout to your history.",
      },
      {
...

  {
    ...
    excerpt: 'Pill reminder apps send you alerts when it is time to take each medication. Here are the best free options and how to set them up.',
    category: 'health-tech',
    tags: [
      'pill reminder',
      'medication app',
...

  {
    ...
    excerpt: 'Paramount+ streams CBS shows, movies from Paramount Pictures, live sports, and news. Here is how to sign up, navigate, and find the best content.',
...

  {
    ...
    excerpt: 'Your phone has powerful built-in photo editing tools. Here is how to straighten, crop, adjust brightness, and remove red-eye — no special app needed.',
    category: 'phone-guides',
    ...
    steps: [
      {
        ...
        content: "Open the Photos app and tap any photo. Tap \"Edit\" in the top right. The editing toolbar appears along the bottom of the screen with three sections: Adjustments (sliders for brightness, exposure, contrast, etc.), Filters (preset looks), and Crop (crop and straighten tools). Tap each icon to switch between sections. Tap \"Done\" to save your edits, or \"Cancel\" → \"Discard Changes\" to undo everything.",
...

  {
    ...
    excerpt: "Forwarding a text message shares it with someone who wasn't part of the original conversation. Here's how to do it on iPhone and Android.",
    category: 'essential-skills',
    ...
    steps: [
      {
        ...
        content: "Open the Messages app. Find and open the conversation containing the message you want to forward. Press and hold on the specific message bubble (not the entire conversation). A menu appears — tap \"More.\" Small circles appear next to each message — tap the circle next to the message(s) you want to forward to add a checkmark. Tap the forward arrow (curved arrow icon) at the bottom right of the screen. A new message compose window opens with the text pre-filled. Add the recipient's name or phone number → tap Send.",
      ...
      },
      {
        ...
        content: "Open Google Messages. Open the conversation containing the message. Long-press (press and hold) on the message bubble you want to forward. Tap the three-dot menu (⋮) at the top right → \"Forward.\" A new compose window opens with the message pre-filled. Enter the contact you want to forward to and tap Send.",
      },
      {
        title: 'Copy and paste text if forwarding is not available',
        content: "If you cannot find a forward option, you can copy the message text and paste it into a new message. Press and hold on the message bubble → tap \"Copy.\" Open a new message to the recipient → long-press in the text field → tap \"Paste.\" This method works on all phones and all messaging apps, though it does not include any photos or attachments from the original message.",
...

  {
    ...
    excerpt: 'Default apps determine which app opens when you tap a link, an email address, or a phone number. Here is how to change them to your preferred apps.',
    category: 'tips-tricks',
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Go to Settings → scroll down to find your preferred email app (Gmail, Outlook, Spark, etc.) → tap on it → \"Default Mail App\" → select your app. Tapping any email address on a webpage or in a document now opens your chosen email app to compose a message instead of Apple Mail.",
      },
      {
        title: 'Change default apps on Android',
        content: "Android is more flexible with defaults. Go to Settings → Apps → tap the three-dot menu (⋮) or \"Default apps.\" You see options for: Browser app, Phone app, Messaging app, Digital assistant app, and more. Tap any category and choose from the apps you have installed that can handle that function. You can also change defaults when an app asks \"How do you want to open this?\" — tap the app you want and choose \"Always\" to make it the permanent default.",
...

  {
    ...
    excerpt: "Android phones back up to your Google account automatically — but only if you've turned it on. Here's how to verify, run a manual backup, and restore.",
    category: 'phone-guides',
...

  {
    ...
    excerpt: "Apple Shortcuts lets your iPhone do repetitive tasks automatically — one tap sends a message, starts directions home, or sets your morning routine in motion.",
    category: 'tips-tricks',
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Tap \"Automation\" at the bottom of the Shortcuts app → tap the \"+\" to create a new automation. Choose a trigger: \"Time of Day,\" \"Location\" (when you arrive/leave home), or \"App\" (when you open a specific app). For example: every morning at 7 AM, your phone automatically turns off Do Not Disturb and opens your news app. Or when you arrive home, your phone connects to your home Wi-Fi and turns off your VPN automatically.",
      },
    ],
  },

  {
    ...
    excerpt: "iPhone's Live Text feature reads text in any photo or through your camera and lets you copy it, look it up, or call a phone number — no typing required.",
    category: 'tips-tricks',
    ...
    steps: [
      {
        ...
        content: "Go to Settings → General → Language & Region → make sure \"Live Text\" is toggled ON. On most iPhones running iOS 17 or later, this is enabled by default. Live Text works with text in English, French, German, Italian, Portuguese, Spanish, Chinese, Cantonese, Japanese, and Korean.",
      ...
      },
      {
        ...
        content: "Open the Camera app and point your camera at any text — a sign, a business card, a menu, a label. A small, framed icon appears in the bottom right corner (it looks like lines of text inside a small box). Tap that icon. The camera pauses and recognized text is highlighted in yellow. Tap the highlighted text to: \"Copy,\" \"Look Up,\" \"Translate,\" \"Search the Web,\" or if it is a phone number, \"Call\" or \"Add to Contacts.\"",
      },
      {
        title: 'Use Live Text on photos in your Photos app',
        content: "Open any photo in the Photos app that contains text. Look for the Live Text icon (lines in a box) in the bottom right corner of the photo. Tap it to highlight all recognized text in yellow. Long-press on any highlighted text to select it and copy. Tap any recognized phone number to call it, any web address to open the website, or any email address to compose an email. This works on old photos and new ones alike.",
...

  {
    ...
    excerpt: "An organized Android home screen puts your most-used apps front and center. Here's how to rearrange apps, create folders, add widgets, and remove clutter.",
    category: 'tips-tricks',
    ...
    steps: [
      {
        ...
        content: "Long-press (press and hold) any app icon on your home screen. After a moment, the icon lifts and you can drag it to a new position. Drag it to another spot on the same page, or drag it to the edge of the screen to move it to a different home screen page. Release your finger to drop the icon in the new position. Long-pressing also reveals an option to remove the app from the home screen (without uninstalling it) — tap \"Remove\" or drag it to the Remove icon at the top.",
...

  {
    ...
    excerpt: 'Smart TVs can download streaming apps, games, and utilities just like a phone. Here is how to find and install new apps on the most popular TV platforms.',
    category: 'entertainment',
    ...
    steps: [
      ...
      },
      {
        ...
        content: "From the Fire TV home screen, scroll right to \"Find\" → select \"Apps\" or \"App Store.\" Browse the categories or type in the search bar at the top. Click any app → \"Get\" (for free apps) or \"Buy\" (for paid apps). The app downloads and installs automatically. It appears in your app library or on the home screen under \"Your Apps & Channels.\"",
      },
      {
...

  {
    ...
    excerpt: 'A shared calendar lets your whole family see appointments, events, and reminders in one place — everyone stays on the same page without constant phone calls.',
    category: 'essential-skills',
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Open the Calendar app on iPhone → tap \"Calendars\" at the bottom → tap the info icon (ⓘ) next to any calendar → tap \"Add Person\" → enter a family member's iCloud email address → tap \"Add.\" They receive an invitation. Once they accept, events added to that calendar are visible to everyone you shared it with. To add a new event to the shared calendar: when creating an event, tap \"Calendar\" to change which calendar it goes to.",
      },
      {
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "In Split View, a thin vertical divider line appears between the two apps. Click and drag that divider left or right to give more space to one app or the other. One app can be wider than the other — useful if one app needs more space to display properly (like a spreadsheet) while the other is just showing reference material.",
      },
      {
        title: 'Switch which apps are in Split View',
        content: "To swap one of the Split View apps for a different one: move your cursor to the very top of the screen — the menu bar appears briefly. Click the Mission Control button (two overlapping rectangles at the top right, or press the Mission Control keyboard key) to see all your open windows. Drag any other open window into the Split View space to replace the current app there. Or click the green button on either app to exit Split View and return to regular windows.",
      },
      {
        title: 'Exit Split View',
        content: "To exit Split View: move your cursor to the top of the screen → click the green dot on either app → click \"Exit Full Screen\" or \"Move window to desktop.\" Both apps return to regular resizable windows on the desktop. Alternatively, press Escape on the app you want to pull out — though this may depend on the app.",
...

  {
    ...
    excerpt: 'Internet radio gives you access to thousands of live radio stations from across the country and around the world — completely free. Here is how to tune in.',
    category: 'entertainment',
...

  {
    ...
    excerpt: 'You can borrow free eBooks from your public library and read them on your phone or tablet using the Kindle app — no Kindle device needed.',
    category: 'app-guides',
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Download the free \"Libby\" app (by OverDrive) from your app store. Open Libby → tap \"Find My Library\" → search for your public library by city or name. Tap \"Sign In with Library Card\" → enter your library card number (the long number on the back of your card) and PIN. You now have access to your library's entire digital catalog. Search for any book → if available, tap \"Borrow\" → it appears in your Libby loans. Tap \"Read with Kindle\" to send it to your Kindle app, or read directly in Libby.",
      },
      {
