...
**Quick Tip:** Duplicate photos also eat up storage. In iOS 17 and later, the Photos app automatically detects duplicate photos. In the Albums tab, scroll down to "Utilities" and look for a **Duplicates** album. Tap **Merge** next to each group to keep the best version and delete the rest.
