// guides-batch-284 (recovered from main's original batch 140) — Auto-generated by creative-loop on 2026-05-05
// Topics: How to Use Uber or Lyft for the First Time; Set Up Medication Reminders on iPhone (Built-In, Free)

import type { Guide } from './guides';

export const guidesBatch284: Guide[] = [
  {
...
The Medications feature works on iPhone running iOS 17 or later. Older iPhones can use the Reminders app for a simpler version.
