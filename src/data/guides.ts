...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    description: 'Book and attend an NHS or private online doctor appointment from your phone, tablet, or computer — no waiting room required.',
    category: 'how-to',
    emoji: '🩺',
    readTime: 8,
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    description: 'Stop losing documents and photos. Learn how to find, rename, move, and tidy up files on Windows and Mac.',
    category: 'essential-skills',
    emoji: '📁',
    readTime: 7,
    difficulty: 'Beginner',
  ...
  },
  {
    ...
    description: 'Capture what\'s happening on your screen to share with family, save a video, or show a tech problem to someone who can help.',
    category: 'how-to',
    emoji: '🎥',
    readTime: 6,
    difficulty: 'Beginner',
  ...
  {
    id: 'hearing-aid-bluetooth',
    title: 'Connecting Hearing Aids to Your Phone via Bluetooth',
    description: 'Pair modern Bluetooth hearing aids with an iPhone or Android phone to stream calls, music, and TV audio directly to your ears.',
    category: 'how-to',
    emoji: '👂',
    readTime: 7,
    difficulty: 'Beginner',
