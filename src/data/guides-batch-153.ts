...
export const guidesBatch153: Guide[] = [
  {
    ...
    excerpt: 'Siri is your iPhone\'s built-in voice assistant. Learn how to turn it on, ask it questions, make calls, set reminders, and change its voice — all hands-free.',
...
Make sure your iPhone is running a current version of iOS. Open Settings, tap General, then tap Software Update to check. Siri works best with a reliable Wi-Fi or cell signal when answering questions from the internet, though basic tasks like timers and alarms work without any connection.`,
    steps: [
      {
      ...
      },
      {
        ...
        warning: 'The "Hey Siri" feature works only when your iPhone is plugged in or when Low Power Mode is off. If the battery is very low, Siri may not respond to your voice until you plug in.',
      },
      {
...

  {
    ...
    excerpt: 'App updates fix security problems and add new features. Learn how to turn on automatic updates on any device so your apps stay current without extra effort.',
    category: 'phone-guides',
    tags: [
      'app updates',
      'automatic updates',
...
You only need to follow the section that applies to your device.`,
    steps: [
      {
        ...
        content: 'Open the Settings app (the gray gear icon on your home screen). Scroll down until you see "App Store" and tap it. You will see a section called "Automatic Downloads." Look for the row labeled "App Updates" and make sure the toggle next to it is green (switched to the right). That is all you need to do. From this point on, your iPhone will download and install app updates in the background, usually overnight while your phone is charging and connected to Wi-Fi.',
      ...
      },
      {
        ...
        warning: 'If you use a Samsung phone, Samsung also has its own app store called Galaxy Store with a separate auto-update setting. Open the Galaxy Store app, tap the three horizontal lines in the bottom-right corner, tap Settings, and turn on "Auto update apps."',
      },
      {
...

  {
    ...
    excerpt: 'Your phone can pay at stores, restaurants, and drive-throughs — no wallet needed. Learn how to set up Apple Pay or Google Pay and use it safely at checkout.',
...
Apple Pay is built into every iPhone. You do not need to download anything. You access it through the Wallet app, which comes pre-installed. Google Pay/Google Wallet is also pre-installed on most Android phones, but if you do not see it, you can download it free from the Google Play Store.`,
    steps: [
      ...
      },
      {
        ...
        warning: 'If a terminal does not accept contactless payment, you will see a message or the terminal will not respond. In that case, pay with your physical card as a backup. Not every store has upgraded its equipment yet.',
      },
      {
...
You can save addresses you visit often — like your doctor's office, your child's home, or your favorite grocery store — so you do not have to type them each time. In Google Maps, tap "Saved" at the bottom of the screen, then tap "New list" to create a collection, or tap the bookmark icon when viewing any location. Next time you need directions there, you can select it from your saved places instead of typing.`,
    steps: [
      ...
      },
      {
        ...
        warning: 'Never operate Google Maps while your phone is in your hand while driving. Mount your phone on a dashboard holder, or set it in a cup holder where you can glance at it safely. The spoken directions are designed so you do not need to watch the screen.',
      },
      {
      ...
      },
      {
        ...
        warning: 'Offline maps do not show live traffic, road closures, or updated business hours. They give directions using the road data saved at the time of download. For most trips, this is perfectly fine — roads rarely change.',
      },
    ],
  },
];
