...
export const guidesBatch35: Guide[] = [
  {
    ...
    excerpt: 'Live Transcribe turns speech into text in real time on your Android phone, which helps anyone hard of hearing follow a conversation.',
    ...
    steps: [
      ...
      },
      {
        ...
        content: 'Open Live Transcribe. It asks for microphone permission — tap "Allow." The app begins listening and transcribing right away.',
      },
      {
...

  {
    ...
    excerpt: 'Guided Access locks your iPhone to a single app and can disable the Home button — good for handing your phone to a grandchild, or for focus.',
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        warning: 'End the guest session yourself rather than handing the phone back still in Guest Mode. This makes sure the guest data is wiped and you are back to your own account.',
      },
      {
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: 'When reading an email, scroll to the bottom. Gmail suggests two or three short replies. Tap one to create a quick response you can send right away or edit before sending.',
      },
    ],
  },
