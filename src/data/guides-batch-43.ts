...
Filing a report takes about 5 minutes. No immediate personal action results from a single report, but patterns of reports trigger investigations.`,
...

  {
    ...
    publishedAt: `2026-04-19`,
    difficulty: `Beginner`,
    body: `The Weather app on iPhone got a big upgrade with iOS 17 and later. It's now one of the most detailed weather apps around. It's free and already on your phone.

Most people only see the main temperature. But scroll down and you'll find much more. There are hourly forecasts for the next 24 hours, a 10-day outlook, the air quality index (useful if you have a breathing condition), UV index, wind speed and direction, chance and strength of rain or snow, sunrise and sunset times, and moon phases.
...
**Weather maps**: Swipe to the bottom of the app to see a precipitation map. It animates to show where rain and snow are moving. This is useful for planning outdoor plans.

**Multiple locations**: You can add multiple cities to watch. This helps for checking weather at a destination before you travel, or seeing weather where family members live.

The app pulls weather data from several sources, including The Weather Channel and government weather agencies. This gives you detailed and generally accurate forecasts.`,
    steps: [
      {
