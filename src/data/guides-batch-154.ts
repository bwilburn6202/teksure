...
**Method 3: Use iPhone Mail's Unsubscribe feature**

If you read email on an iPhone using the built-in Mail app, a blue "Unsubscribe" banner appears at the top of many marketing emails — right above the message — with a one-tap button to unsubscribe.
