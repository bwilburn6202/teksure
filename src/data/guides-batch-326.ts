  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Real delivery companies do not charge a fee by text message to redeliver a package. If a page asks for your credit card number, full address, or Social Security number after tapping a delivery text link, close it right away.",
