  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        warning: "If you feel dizzy, lightheaded, short of breath, or unusually weak during a session, turn off the unit right away and call your doctor. These are rare reactions that require medical review."
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Outpatient physical therapy usually begins one to two weeks after surgery, with two visits per week for the first month and one to two visits per week through week 12. Each visit lasts 45 to 60 minutes and combines hands-on stretching, guided strengthening exercises, balance practice, and gait training. The therapist will progress your exercises every two weeks as strength returns. Medicare Part B covers the visits at 80 percent after the deductible, with no cap on the number of visits as long as the therapy remains medically necessary. Do your home exercises at least five days a week between visits. Seniors who complete all 12 weeks walk 30 percent farther and have half the fall rate of those who stop at six weeks.",
        warning: "Pain that suddenly worsens, a popping or clunking sensation in the hip, or a leg that looks shorter or rotated outward can mean dislocation. Go to the emergency room right away."
      },
      {
