...
export const guidesBatch17: Guide[] = [
  {
    ...
    excerpt: "Wi-Fi calling lets you make and receive calls over your home internet when your cell signal is weak or unavailable — here's how to turn it on.",
...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: 'Email attachments — especially photos and videos that people have emailed you over the years — are often the biggest storage users. In Gmail, search for large emails with: size:10MB (finds emails over 10MB). Read the email list and delete ones you no longer need, especially those with large attachments. After deleting, empty the Trash folder: in Gmail, click "More" in the left sidebar → "Trash" → "Empty Trash now." Trash counts against your storage until emptied.',
...

  {
    ...
    excerpt: 'Act quickly and follow these steps to recover a hacked social media or email account — and prevent it from happening again.',
    ...
    steps: [
      ...
      },
      {
        ...
        warning: "If you use the same password on multiple sites and one site is breached, hackers will automatically try that password everywhere. Each account should have a unique password — this is the single biggest step you can take for online security.",
      },
      {
      ...
      },
      {
        ...
        content: "After recovering access, check what devices are logged into your account. On Facebook: Settings → Password and Security → \"Where you're logged in\" — log out all unfamiliar devices. On Instagram: Settings → Security → Login activity → log out anything unfamiliar. Also check \"Apps and Websites\" or connected apps (Facebook: Settings → Apps and Websites) and remove any apps you don't recognize. Alert your friends and family that your account was compromised so they know to ignore any suspicious messages they received.",
...

  {
    ...
    excerpt: 'Say the word and Alexa adds items to your shopping list, which syncs to your phone. You can also reorder Amazon items by voice — here is how it all works.',
    category: 'smart-home',
    ...
    steps: [
      {
        ...
        content: "Say \"Alexa, add milk to my shopping list\" or \"Alexa, add bread, butter, and eggs to my shopping list.\" Alexa confirms each item. Your list is saved automatically. To hear what is on the list: say \"Alexa, what is on my shopping list?\" To check the list on your phone: open the Alexa app → Lists (in the bottom navigation or hamburger menu) → Shopping List. The list stays in sync between your Echo and the app.",
      ...
      },
      {
        ...
        content: "To let Alexa place orders on Amazon: open the Alexa app → More → Settings → Account Settings → Voice Purchasing → turn on \"Purchase by voice.\" You can optionally add a 4-digit confirmation code so no one accidentally places an order. With voice purchasing on, you can say: \"Alexa, reorder [product name]\" and Alexa will confirm from your Amazon purchase history and ask \"Should I place this order?\" before purchasing.",
        warning: "If you have children or grandchildren visiting who use your Echo, consider requiring a confirmation code for purchases, or turning off voice purchasing when they are present to prevent accidental orders.",
      },
      {
        title: 'Check on your Amazon orders',
        content: "You can ask Alexa about your recent orders: \"Alexa, where is my stuff?\" or \"Alexa, track my package.\" Alexa will give you a delivery status update for recent orders. For more detail, open the Amazon app on your phone and go to Returns & Orders to see tracking information. You can also say \"Alexa, cancel my order\" for recent orders that have not yet shipped.",
...

  {
    ...
    excerpt: 'Amazon makes it straightforward to see exactly where your package is, get delivery alerts, and find out what to do if something goes wrong.',
    category: 'app-guides',
...

  {
    ...
    excerpt: "5G is the newest cellular network technology. Here's what it actually means for your phone, whether you need it, and what the hype is really about.",
    category: 'essential-skills',
...

  {
    ...
    excerpt: "Before you give up an old phone, perform a factory reset to erase all your personal data. Here's exactly how to do it safely on iPhone and Android.",
    ...
    steps: [
      {
        ...
        content: "Before erasing the phone, confirm that everything you want to keep is saved somewhere else. On iPhone: go to Settings → your name → iCloud → iCloud Backup → \"Back Up Now.\" Wait for the backup to complete. On Android: go to Settings → Google → Backup → \"Back up now.\" Also manually save or email any photos or files you want to keep that might not be in the cloud. Double-check your contacts, photos, and apps are saved before proceeding — a factory reset cannot be undone.",
        warning: 'There is no way to recover data after a factory reset. Confirm your backup was successful before starting the reset.',
      },
      {
        title: 'Sign out of accounts before resetting (iPhone — important)',
        content: 'On iPhone, you must sign out of your Apple ID before erasing to turn off Activation Lock. If you skip this step, the next person cannot set up the iPhone. Go to Settings → tap your name at the top → scroll down → \"Sign Out.\" Enter your Apple ID password when prompted and tap \"Sign Out\" again to confirm. Now the phone is clear of your Apple ID and ready to reset.',
...

  {
    ...
    excerpt: 'Certified refurbished phones can save you $200-$400 compared to new — and they work reliably when bought from the right sources. Here is what to look for.',
    category: 'phone-guides',
...

  {
    ...
    excerpt: "You can use your phone as a TV remote — no more searching for the physical remote. Here's how to set it up for Samsung, LG, Roku, Fire TV, and Apple TV.",
...

  {
    ...
    excerpt: "Group FaceTime lets up to 32 people join a video call at the same time. Here's how to start one and what to do if someone can't connect.",
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Once a FaceTime call is in progress, you can add more people. Tap the screen to show controls → tap the person icons at the bottom → tap \"Add People\" → enter the new person's name or number → \"Add to FaceTime.\" They receive a notification to join.",
      },
      {
        title: 'Invite Android or Windows users with a FaceTime link',
        content: "Open the FaceTime app → tap \"Create Link\" at the top. This generates a web link you can share via text, email, or any messaging app. When Android or Windows users tap the link, FaceTime opens in their web browser (Google Chrome recommended) and they can join the call without an Apple account. They are shown as a participant like everyone else.",
      ...
      },
      {
        ...
        content: "During a group call, each person appears in a tile. The tile of whoever is currently speaking enlarges automatically. To change your camera view: tap the icon to switch between front camera (shows your face) and back camera (shows what is in front of you). To mute yourself: tap the microphone icon. To leave the call: tap the red phone icon. You can also use Portrait mode for a blurred background: tap \"Effects\" → \"Portrait\" during the call.",
...

  {
    ...
    excerpt: 'Google Maps and Apple Maps let you download areas of the map in advance so you can navigate without cell service or Wi-Fi — perfect for travel or rural areas.',
    category: 'app-guides',
...

  {
    ...
    excerpt: 'Digital photo frames display a rotating slideshow of your photos — and modern Wi-Fi frames let family send new photos remotely. Here is how to set one up.',
    category: 'entertainment',
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Most Wi-Fi frames walk you through Wi-Fi setup on first startup — the frame's screen shows a step-by-step wizard. Select your Wi-Fi network name from the list and enter your Wi-Fi password. The frame may show a QR code you can scan with your phone to complete setup. Once connected, the frame downloads any photos already uploaded to your account and begins the slideshow.",
      },
      {
...

  {
    ...
    excerpt: 'A lock screen passcode or biometric lock protects everything on your phone if it is ever lost or stolen. Here is how to set up the strongest options available.',
    category: 'safety-guides',
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Go to Settings → Security → Screen lock. Choose between PIN (numbers only), Password (letters and numbers), or Pattern (draw a pattern). PIN or Password is recommended over Pattern — patterns are easier to guess. Enter a 6+ digit PIN or strong password and confirm it. Then go back to Security → \"Fingerprint\" or \"Biometrics\" → set up your fingerprint by pressing your finger on the fingerprint sensor multiple times as instructed. On Samsung: Settings → Biometrics and security. On Google Pixel: Settings → Security → Fingerprint Unlock.",
...

  {
    ...
    excerpt: 'Your phone can notify you instantly about tornadoes, floods, AMBER alerts, and local emergencies. Here is how to make sure those alerts are turned on.',
    category: 'safety-guides',
    ...
    steps: [
      {
        ...
        content: 'Go to Settings → Notifications → scroll to the very bottom. You will see a section called "Government Alerts" with toggles for: AMBER Alerts, Emergency Alerts (extreme threats like tornados), and Public Safety Alerts. Make sure all are turned ON (green). Also look for "Enhanced Emergency Alerts" if it appears — turn it on for more detailed warnings.',
...

  {
    ...
    excerpt: 'Night Mode on iPhone and Android automatically improves photos taken in dark conditions — no flash needed. Here is how it works and how to get the best results.',
    category: 'phone-guides',
    ...
    steps: [
      {
        ...
        content: "On iPhone 11 and later, Night Mode turns on automatically when the camera detects low light. You will see a yellow crescent moon icon appear in the top left of the Camera app when Night Mode is active. The number next to the moon shows how many seconds the exposure will take (for example, \"2s\" means the photo takes 2 seconds). Tap the moon icon to adjust the exposure time or turn it off. Leave it on and at the automatic time for best results in most situations.",
...

  {
    ...
    excerpt: "If you misplace your AirPods, Apple's Find My app can show their last known location and play a sound to help you find them nearby.",
...

  {
    ...
    excerpt: 'An overflowing Gmail inbox is overwhelming. Learn how to use labels, filters, and the archive feature to keep your inbox manageable and find emails fast.',
    category: 'essential-skills',
    ...
    steps: [
      {
        ...
        content: "Log in to Facebook on a computer (this is easier on a computer than the app). Click the small triangle or your profile picture icon in the top right → \"Settings & Privacy\" → \"Settings\" → in the left sidebar click \"Your Facebook information\" → \"Download your information\" or \"Transfer a copy.\" Click \"Download or transfer information.\" You can choose \"All time\" to get everything.",
      ...
      },
      {
        ...
        content: "A list of data categories appears: Posts, Photos and Videos, Messages, Friends, Groups, Events, Marketplace, and more. Select \"All\" to get everything, or check only what you want. Under Format, choose \"HTML\" to view files in a browser (more readable) or \"JSON\" (technical format for importing elsewhere). Under Media quality: choose \"High\" to get photos at their original resolution. Click \"Create file.\"",
      },
      {
        title: 'Wait for the file and download it',
        content: "Facebook will prepare your download — this can take anywhere from a few minutes to several hours depending on how much data you have. You will receive a notification and/or email when the file is ready. Go back to the \"Download Your Information\" page and click the Download button next to your file. Save it to your computer. The file is a compressed archive (.zip file). On Windows, right-click it and \"Extract All.\" On Mac, double-click it to unzip.",
