...
export const guidesBatch15: Guide[] = [
  
  {
    ...
    difficulty: 'Beginner',
    body: "When your Windows computer gets slow, freezes, or a program stops responding, Task Manager is the tool that helps you understand why and fix it. It shows you every program currently running, and how much of your computer's resources each one uses.",
    steps: [
      {
