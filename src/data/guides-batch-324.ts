...
export const guidesBatch324: Guide[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Report suspected scam calls to the FTC at reportfraud.ftc.gov and to your phone carrier. If you already sent money, contact your bank or the gift card company right away — some can freeze or reverse a transaction if you act fast.",
