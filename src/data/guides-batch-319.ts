...
export const guidesBatch319: Guide[] = [
  ...
  },
  {
    ...
    lastVerifiedAt: "2026-07-08",
    difficulty: "Beginner",
    body: "Charity scams spike after every major hurricane, wildfire, or other disaster in the news, and again every year during the November-to-December giving season. Scammers set up fake charity names that sound almost identical to real, well-known organizations. Then they push urgent appeals through text messages, social media ads, and phone calls asking for donations right away — often asking specifically for gift cards, wire transfers, or cryptocurrency, which a real charity would never ask for.\n\nThe FTC and the BBB Wise Giving Alliance both offer free tools to check whether a charity is real, and how much of its donations actually reach the cause versus overhead. Taking two extra minutes to check before you donate protects your money and makes sure it reaches people who actually need it.",
    steps: [
      {
