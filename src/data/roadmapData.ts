...
export const roadmapItems: RoadmapItem[] = [
  ...
  { title: 'High Contrast Mode', description: 'A high-contrast colour scheme for users with low vision or sensitivity to bright screens.', status: 'exploring', category: 'Accessibility' },
  ...
  { title: 'Device Health Dashboard', description: 'A personalised overview of your device\'s storage, battery, updates, and security posture in one place.', status: 'exploring', category: 'Tools' },
