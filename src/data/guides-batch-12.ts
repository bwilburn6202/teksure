...
export const guidesBatch12: Guide[] = [
...

  {
    ...
    publishedAt: '2026-04-19',
    difficulty: 'Beginner',
    body: "Two-step verification adds a second lock to your front door. It is also called two-factor authentication, or 2FA. Even if a scammer learns your password, they still cannot get in without your phone too. Security experts call this the single best thing you can do to protect your accounts.",
    steps: [
      {
        title: 'Understand how it works',
        content: `With two-step verification on, logging in takes two steps. Step one: you enter your password as usual. Step two: a text with a short code, like 847291, is sent to your phone. You type that code in. Only then are you let in. A scammer does not have your phone. So they are locked out, even if they know your password.`,
        tip: `Each code is different and expires in a few minutes. Even if a scammer somehow sees one, they cannot reuse it.`,
      },
      {
        title: 'Turn on two-step verification for Gmail',
        content: `Go to myaccount.google.com on a computer or phone browser. Click "Security" in the left column. Scroll to "How you sign in to Google." Click "2-Step Verification." Click "Get Started." Google will ask for your password again, to confirm it is you. Then enter your phone number. Google sends a test code to make sure it works.`,
        tip: `Accounts with two-step verification are far less likely to be hacked. Google's own data shows 2FA blocks nearly all automated break-in attempts.`,
      },
      {
        title: 'Turn on two-step verification for Facebook',
        content: 'On Facebook, tap the three lines (the menu icon). Tap Settings & Privacy, then Settings, then Security and Login. Scroll to "Two-Factor Authentication." Tap "Use two-factor authentication." Choose "Text message (SMS)" and enter your phone number. Facebook sends a test code to confirm it works.',
      },
      {
        title: `What to do if you don't get the verification code`,
        content: `Check that your phone has cell service and is not in airplane mode. A code can take 2-3 minutes to arrive. Most services also offer a backup option. You can ask for the code by a different phone number or email, or use a backup code. Save your backup codes when you set up 2FA. Keep them somewhere safe.`,
      },
    ],
  },
...

  {
    ...
    publishedAt: '2026-04-19',
    difficulty: 'Beginner',
    body: "Apple builds accessibility features into every iPhone. They make the phone easier to use for everyone, especially people with vision, hearing, or hand-strength challenges. These features are already on your phone. You need to turn them on.",
    steps: [
      {
        title: 'Make text larger across your entire iPhone',
        content: 'Go to Settings, then Display & Brightness, then Text Size. Drag the slider right to make text larger in every app. For even larger sizes, go to Settings, then Accessibility, then Display & Text Size. Turn on "Larger Accessibility Sizes." This unlocks a bigger range on the slider.',
        tip: 'Add a Text Size shortcut to Control Center: go to Settings, then Control Center, and add "Text Size." Then adjust font size anytime by swiping down from the top right of your screen.',
      },
      {
        title: 'Make text bolder and increase contrast',
        content: 'Go to Settings, then Accessibility, then Display & Text Size. Turn on "Bold Text" to make letters thicker and easier to see. Turn on "Increase Contrast" too. This makes buttons, text, and icons stand out more clearly.',
      },
      {
        title: 'Turn on Zoom to magnify anything on screen',
        content: 'Go to Settings, then Accessibility, then Zoom, and turn it on. Double-tap the screen with three fingers to zoom in on any area. Drag with three fingers to move around while zoomed in. Double-tap with three fingers again to zoom back out. This works in every app and screen, and on the keyboard.',
        tip: 'If Zoom feels disorienting at first, try "Window Zoom" mode in the Zoom settings. It creates a small floating magnifying window instead of zooming the whole screen.',
      },
      {
        title: 'Enable Reachability for one-handed use',
        content: 'On iPhones with Face ID, the top of the screen can be hard to reach with one hand. Reachability fixes this. Go to Settings, then Accessibility, then Touch, and turn on "Reachability." To use it, swipe down on the very bottom edge of the screen. The top half slides down within thumb reach. Tap what you need. It slides back up on its own.',
      },
      {
        title: 'Reduce motion to prevent dizziness',
        content: 'Some people find iPhone animations cause dizziness or discomfort. Go to Settings, then Accessibility, then Motion, and turn on "Reduce Motion." This replaces most zoom effects with simple fades. Many people find the phone feels calmer and easier to follow with this on.',
      },
    ],
  },
...

  {
    ...
    publishedAt: '2026-04-19',
    difficulty: 'Beginner',
    body: "A password manager is an app that stores all your passwords in one safe place. You remember only one password, called a master password. The app remembers the rest. This lets you use a strong, different password for every account. You do not have to memorize them all.",
    steps: [
      {
        title: 'Create a free Bitwarden account',
        content: `Bitwarden is a free password manager that security experts trust. Open a browser on your computer or phone. Go to bitwarden.com. Click "Get Started Free." Create an account with your email address. Then choose a master password. This is the one password you need to remember. Pick something you will not forget, but others could not guess. A song phrase with a few numbers added works well.`,
        warning: 'Write your master password down. Keep it somewhere safe at home, like a notebook. Bitwarden cannot recover this password for you if you forget it.',
      },
      {
        title: 'Download the Bitwarden app on your phone',
        content: 'Search for "Bitwarden" in the App Store (iPhone) or Google Play Store (Android). Install the free app. Sign in with the email and master password you just created. The app will ask to fill in passwords automatically. Tap "Allow." This lets it save and fill passwords in other apps and your browser.',
      },
      {
        title: 'Let Bitwarden save passwords as you log in',
        content: `The next time you log in to any app or website, Bitwarden will offer to save the password. Tap "Save." After a few days, Bitwarden will have your most important passwords stored. You can also add a password by hand. Tap the "+" button in the app.`,
        tip: `You do not need to add every password at once. Let Bitwarden save them naturally as you log in over the next few weeks.`,
      },
      {
        title: 'Use Bitwarden to auto-fill passwords',
        content: 'Open a login screen in an app or browser. Look for the Bitwarden icon near the username or password field. Tap it. Bitwarden fills in your saved username and password. No typing needed. On iPhone, look for a "Passwords" suggestion above the keyboard instead.',
      },
      {
        title: 'Try the built-in password manager on your device',
        content: `Bitwarden feels like too many steps? iPhone and Android both have a simpler, built-in option. On iPhone, go to Settings, then Passwords. On Android, go to Settings, then Passwords & accounts. These do not sync across devices. But they are a good place to start.`,
        tip: `Apple's built-in password manager is called "Keychain." When Safari asks to save a password and you tap "Save," it goes into Keychain and fills in automatically next time.`,
      },
    ],
  },
