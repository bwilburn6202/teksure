...
export const guidesBatch198: Guide[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Trip insurance for travelers over 60 usually costs 5% to 10% of the trip's total non-refundable cost. Get a quote at InsureMyTrip.com or Squaremouth.com and add the figure to the budget. Then take the running total of every category so far and add 15% as a cushion. The cushion absorbs missed flights, an extra cab, a souvenir, or an unexpected pharmacy visit. Without a cushion, the budget will almost certainly be broken.",
