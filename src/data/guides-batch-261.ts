  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Most sites ask for proof of age (drivers license, state ID, or Medicare card), proof of where you live (a utility bill), and a self-declaration of income. If you already receive SNAP, Medicaid, SSI, or LIHEAP heating help, bring proof of that. It usually substitutes for income documentation. The application itself is one page. Approval is often same-day.",
    ...
    steps: [
      {
        ...
        tip: "Quick Tip: Dial 211 from any phone to be connected to a local food help directory. It is a free national service run by United Way and works in every state.",
      },
      {
