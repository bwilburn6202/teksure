...
export default function CourseCertificate() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background print:bg-card">
        ...
        {!complete ? (
          <section className="container max-w-3xl mx-auto px-4 py-12">
            <Card className="border-border">
              <CardContent className="p-8 text-center">
                <div className="inline-flex p-3 rounded-full bg-amber-500/10 text-warn-foreground mb-4">
          ...
          <>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3">
                    <div className="flex-1 min-w-0 w-full">
                      <label htmlFor="cert-name" className="text-base font-medium">
                        Name on certificate
                      </label>
                      <Input
                        id="cert-name"
            ...
            <section className="container max-w-4xl mx-auto px-4 pb-16 print:py-0 print:px-0 print:max-w-none">
              <div
                ...
                className="relative bg-card text-foreground border-[6px] border-double border-amber-500 rounded-2xl p-10 md:p-14 shadow-md print:shadow-none print:rounded-none print:border-[6px] print:border-amber-500"
                style={{ aspectRatio: '297 / 210' }}
              >
                {/* Ornamental corner */}
                <div className="absolute top-4 right-4 flex items-center gap-1 text-warn-foreground">
                  <Sparkles className="h-4 w-4" aria-hidden="true" />
                  <span className="text-xs tracking-widest uppercase">TekSure</span>
                </div>

                <div className="h-full flex flex-col items-center justify-center text-center">
                  <div className="inline-flex p-4 rounded-full bg-amber-500/10 text-warn-foreground mb-4">
                    <Trophy className="h-10 w-10" aria-hidden="true" />
                  </div>

                  <p className="text-xs md:text-sm tracking-[0.3em] uppercase text-muted-foreground mb-2">
                  ...
                  <p className="text-base md:text-base text-muted-foreground mb-2">This certifies that</p>
                  <p className="text-3xl md:text-5xl font-serif font-bold text-foreground mb-5 max-w-full break-words">
                    {displayName}
                  </p>

                  <p className="text-base md:text-base text-muted-foreground max-w-xl mx-auto mb-6">
