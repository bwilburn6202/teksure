      ...
      <main className="min-h-[80vh] flex items-center justify-center px-4 py-16">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <div className="flex justify-center">
            <div className="h-24 w-24 rounded-full bg-warn flex items-center justify-center">
              <XCircle className="h-12 w-12 text-warn-foreground" />
            </div>
          </div>
          ...
          <Card className="rounded-2xl border border-border bg-card">
            <CardContent className="p-5 text-left space-y-3">
              <p className="font-semibold text-base mb-2">What would you like to do?</p>
