...
export const tools: Tool[] = [
  ...
  {
    title: 'Hearing Aid Care Log',
    description: 'Track battery changes, weekly cleanings, wax guard changes, and audiologist visits. See what is on track and what is overdue.',
    icon: Headphones,
    path: '/tools/hearing-aid-care-log',
    color: 'text-blue-600',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Tracker',
    category: 'Health',
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'hearing aid care log battery change cleaning wax guard audiologist medicare seniors maintenance schedule',
  },
  {
    title: 'Digital Account Inventory',
    description: "List your online accounts (no passwords) so family knows what exists. Group by category (email, banking, social), mark wishes per account.",
    icon: Lock,
    path: '/tools/digital-account-inventory',
    color: 'text-purple-600',
    bg: 'bg-purple-50 dark:bg-purple-950/30',
    badge: 'Directory',
    category: 'Safety',
    ...
    time: '15 min',
    newThisMonth: true,
    keywords: 'digital account inventory legacy email bank social media streaming family executor incapacitated wishes seniors',
  },
  {
    title: 'Tax Receipt Box',
    description: 'Track tax-deductible receipts year-round in 8 categories (medical, charity, property tax, mortgage, more). Yearly total per category. Print summary for your tax preparer.',
    icon: Receipt,
    path: '/tools/tax-receipt-box',
    color: 'text-emerald-700',
    bg: 'bg-emerald-50 dark:bg-emerald-950/30',
    badge: 'Tracker',
    category: 'Money',
    ...
    time: '2 min',
    newThisMonth: true,
    keywords: 'tax receipt box deductible medical charity property mortgage interest itemize 1040 schedule a year round seniors',
  },
  {
  ...
  {
    title: 'Daily Medication Timer',
    description: "Build today's medication schedule grouped by time. Tap each medication after taking it. 6 time presets, with-food markers, taken/total counter, printable.",
    icon: Pill,
    path: '/tools/medication-timer',
    color: 'text-emerald-600',
    bg: 'bg-emerald-50 dark:bg-emerald-950/30',
    badge: 'Tracker',
    category: 'Health',
    ...
    time: '5 min',
    newThisMonth: true,
    keywords: 'medication timer daily schedule pill morning evening with food check off taken senior pillbox tracker',
  },
  {
    title: 'Dividend Income Tracker',
    description: 'Log dividend payments by stock symbol. See yearly total, per-stock breakdown with payment counts. Print summary for tax preparation.',
    icon: DollarSign,
    path: '/tools/dividend-income-tracker',
    color: 'text-emerald-700',
    bg: 'bg-emerald-50 dark:bg-emerald-950/30',
    badge: 'Tracker',
    category: 'Money',
    ...
    time: '2 min',
    newThisMonth: true,
    keywords: 'dividend income tracker stock symbol brokerage 1099 DIV taxable retirement portfolio yield reinvest seniors',
  },
  {
    title: 'Weekly Chores Checklist',
    description: '7-day chore rotation. Start with 14 ready-made household tasks or build your own. Check off each day, reset every Sunday.',
    icon: ClipboardCheck,
    path: '/tools/weekly-chores-checklist',
    color: 'text-emerald-600',
    bg: 'bg-emerald-50 dark:bg-emerald-950/30',
    badge: 'Checklist',
    category: 'Home',
  ...
  },
  {
    ...
    description: 'Fast two-way Fahrenheit ↔ Celsius converter. Auto-detects fever range, room temperature, baking range, freezing/boiling points.',
    icon: Thermometer,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'temperature converter fahrenheit celsius fever body 98.6 100.4 100 oven baking cooking weather seniors',
  },
  {
    title: 'Cooking Measurement Converter',
    description: 'Convert cups, tablespoons, teaspoons, ounces, sticks of butter, quarts, gallons in one chart. Type once, see all 8 conversions.',
    icon: ChefHat,
    path: '/tools/cooking-measure-converter',
    color: 'text-amber-600',
    bg: 'bg-amber-50 dark:bg-amber-950/30',
    badge: 'Calculator',
    category: 'Entertainment',
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'cooking measurement converter cups tablespoons teaspoons ounces sticks butter quart gallon recipe seniors',
  },
  {
    title: 'Age Calculator',
    description: 'Enter a birthday and see exact age in years, months, days, total days alive, and days until next birthday.',
    icon: Cake,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'age calculator birthday days alive years months next birthday seniors grandchild',
  },
  {
    title: 'Distance Converter',
    description: 'Type miles and see kilometers, feet, yards, and meters at once. Handy for travel and walking targets.',
    icon: MapPin,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'distance converter miles kilometers feet yards meters seniors travel walk',
  },
  {
    title: 'Weight Converter',
    description: 'Two-way pounds and kilograms converter plus ounces, stones, and grams. For health, shipping, recipes.',
    icon: Scale,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'weight converter pounds kilograms ounces stones grams seniors lbs kg',
  },
  {
    title: 'Time Zone Converter',
    description: 'Type a time in one US time zone and see every other US zone plus London and Paris. Perfect for scheduling family calls.',
    icon: Clock,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'time zone converter pacific mountain central eastern alaska hawaii london paris call family schedule seniors',
  },
  {
    title: 'Days Between Dates',
    description: 'Pick two dates and see days, weeks, months, and years between. Count down to a trip, or count back from a milestone.',
    icon: Calendar,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'days between dates countdown anniversary birthday vacation appointment seniors',
  },
  {
    title: 'Percent Off Calculator',
    description: 'Type the price and the percent off and instantly see the sale price and how much you save. Quick-pick chips for common discount levels.',
    icon: Tag,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'percent off calculator sale price discount savings shopping seniors',
  },
  {
    title: 'BMI Calculator',
    description: 'Type your height and weight in US units (feet/inches/pounds) to see Body Mass Index with the standard CDC range.',
    icon: HeartPulse,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'BMI calculator body mass index weight height pounds feet inches CDC healthy overweight seniors',
  },
  {
    title: 'Loan Payment Calculator',
    description: 'Type the loan amount, term, and rate to see monthly payment, total paid, and total interest. Works for mortgages, auto, personal loans.',
    icon: Calculator,
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'loan payment calculator mortgage auto personal interest monthly term years seniors',
  },
  {
    title: 'Hourly to Annual Salary',
    description: 'Convert hourly wage to weekly, monthly, and yearly pay. Adjustable hours per week with quick-pick chips.',
    icon: DollarSign,
    path: '/tools/hourly-to-annual',
    color: 'text-emerald-700',
    bg: 'bg-emerald-50 dark:bg-emerald-950/30',
    badge: 'Calculator',
    category: 'Money',
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'hourly to annual salary wage weekly monthly yearly gross pre tax part time work seniors',
  },
  {
    title: 'RMD Calculator',
    description: 'Required Minimum Distribution calculator for IRAs and 401(k)s. Uses the IRS Uniform Lifetime Table for ages 73-100.',
    icon: PiggyBank,
    path: '/tools/rmd-calculator',
    color: 'text-emerald-700',
    bg: 'bg-emerald-50 dark:bg-emerald-950/30',
    badge: 'Calculator',
    category: 'Money',
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'RMD calculator required minimum distribution IRA 401k traditional age 73 uniform lifetime table seniors retirement',
  },
  {
    title: 'Text Size Showcase',
    description: 'See the same sentence at every common font size. Find the size that works for your eyes, then match it on your devices.',
    icon: Type,
    path: '/tools/text-size-showcase',
    color: 'text-blue-600',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Reference',
    category: 'Accessibility',
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'text size showcase font reading vision accessibility small medium large seniors',
  },
  {
    title: 'Car Loan Comparison',
    description: 'Compare two car loan offers side-by-side. See monthly payment, total cost, and total interest for each.',
    icon: Car,
    path: '/tools/car-loan-compare',
    color: 'text-blue-600',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Calculator',
    category: 'Money',
    ...
    time: '3 min',
    newThisMonth: true,
    keywords: 'car loan comparison dealer financing rate apr monthly payment total interest seniors auto',
  },
  {
    title: 'Mail Address Label Maker',
    description: 'Type each recipient and print neat mailing labels — 10 per page, ready for an envelope or holiday card mailing.',
    icon: Mail,
    path: '/tools/mail-label-maker',
    color: 'text-blue-600',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Builder',
    category: 'Family',
    ...
    time: '5 min',
    newThisMonth: true,
    keywords: 'mail address label maker holiday card envelope printing batch labels seniors',
  },
  {
    title: 'Emergency Quick Dial Card',
    description: '9 national numbers (911, 988, Poison Control, Medicare, SSA, AARP Fraud Watch) plus your doctor/pharmacy/neighbor. Print and tape to the fridge.',
    icon: Siren,
    path: '/tools/emergency-quick-dial-card',
    color: 'text-red-600',
    bg: 'bg-red-50 dark:bg-red-950/30',
    badge: 'Card',
    category: 'Safety',
    ...
    time: '5 min',
    newThisMonth: true,
    keywords: 'emergency quick dial card 911 988 poison control medicare SSA AARP fraud doctor pharmacy fridge seniors',
  },
  {
    title: 'Printable Monthly Calendar',
    description: 'Pick any month and year, add appointments and birthdays, then print a full-size calendar with your notes for the fridge or wall.',
    icon: Calendar,
    path: '/tools/printable-monthly-calendar',
    color: 'text-blue-600',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Builder',
    category: 'Family',
    ...
    time: '5 min',
    newThisMonth: true,
    keywords: 'printable monthly calendar fridge wall birthday appointment notes seniors family',
  },
  {
    title: 'Refi Break-Even Calculator',
    description: 'See how many months refinance savings need to recoup the closing costs. Old vs new payment side by side.',
    icon: Calculator,
    path: '/tools/refi-break-even-calculator',
    color: 'text-emerald-700',
    bg: 'bg-emerald-50 dark:bg-emerald-950/30',
    badge: 'Calculator',
    category: 'Money',
    ...
    time: '3 min',
    newThisMonth: true,
    keywords: 'mortgage refinance break even closing costs monthly savings recoup seniors home',
  },
  {
  ...
  {
    title: 'SS Claiming Age Chart',
    description: 'See your monthly Social Security benefit at every claiming age from 62 to 70 based on your Full Retirement Age amount.',
    icon: Landmark,
    path: '/tools/ssa-claiming-age-chart',
    color: 'text-blue-700',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Chart',
    category: 'Money',
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'social security claiming age 62 67 70 chart FRA full retirement age benefit reduction seniors',
  },
  {
    title: 'Daily Spending Log',
    description: 'Log spends in 10 seconds. See today, last 7 days, last 30 days totals plus a breakdown by category.',
    icon: Wallet,
    path: '/tools/daily-spending-log',
    color: 'text-emerald-700',
    bg: 'bg-emerald-50 dark:bg-emerald-950/30',
    badge: 'Tracker',
    category: 'Money',
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'daily spending log expense tracker categories groceries gas health seniors budget',
  },
  {
    title: 'Advance Directive Worksheet',
    description: 'A starter worksheet for end-of-life wishes — CPR, breathing tube, hospice location, organ donation. Print and use to guide the family conversation.',
    icon: FileText,
    path: '/tools/advance-directive-worksheet',
    color: 'text-blue-700',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Worksheet',
    category: 'Health',
  ...
  {
    title: 'Solo Ager Plan',
    description: 'A planning worksheet for older adults aging without close family. Map your healthcare proxy, daily check-in person, key contacts, and what happens if anything goes wrong.',
    icon: Users,
    path: '/tools/solo-ager-plan',
  ...
  {
    title: 'Prescription Price Compare',
    description: 'Compare what a prescription costs across your insurance, Costco cash, GoodRx coupon, and your local pharmacy. See the cheapest option and your potential savings.',
    icon: Pill,
    path: '/tools/prescription-price-compare',
    color: 'text-rose-700',
    bg: 'bg-rose-50 dark:bg-rose-950/30',
    badge: 'Calculator',
    category: 'Health',
