...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: 'Log readings (systolic/diastolic/pulse) with context. Auto-classifies using AHA guidelines: Normal, Elevated, Stage 1, Stage 2, Crisis. 7-day average.',
    icon: HeartPulse,
    path: '/tools/blood-pressure-log',
    color: 'text-red-600',
    bg: 'bg-red-50 dark:bg-red-950/30',
    badge: 'Tracker',
    category: 'Health',
    ...
    time: '2 min',
    newThisMonth: true,
    keywords: 'blood pressure log systolic diastolic pulse AHA hypertension stage 1 2 crisis 180 120 doctor printable seniors',
  },
  {
    title: 'Text Message Templates',
    description: '19 ready-to-use text messages for everyday, family, sympathy, asking for help, and appointments. One tap to copy.',
    icon: MessageSquare,
    path: '/tools/text-message-templates',
    color: 'text-blue-500',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Reference',
    category: 'Setup',
    ...
    time: '1 min',
    newThisMonth: true,
    keywords: 'text message templates running late thinking of you sympathy birthday anniversary appointment cancel reschedule copy paste seniors',
  },
  {
    title: 'Formal Letter Templates',
    ...
    icon: Mail,
    path: '/tools/formal-letter-templates',
    color: 'text-blue-700',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Templates',
    category: 'Learning',
    ...
    time: '5 min',
    newThisMonth: true,
    keywords: 'formal letter templates complaint thank you condolence medicare appeal congratulations congressional medical records request seniors',
  },
  {
    title: 'Fall Risk Self-Assessment',
    description: '12 yes/no questions adapted from the CDC STEADI fall risk questionnaire. See your risk level plus next steps.',
    icon: ShieldAlert,
    path: '/tools/fall-prevention-assessment',
    color: 'text-amber-600',
    bg: 'bg-amber-50 dark:bg-amber-950/30',
    badge: 'Quiz',
    category: 'Health',
  ...
  {
    title: 'First 30 Days After Losing a Spouse',
    description: 'A compassionate, plainspoken checklist of essential tasks in the first month — death certificates, Social Security, life insurance claims, paperwork, and giving yourself permission to rest.',
    icon: Heart,
    path: '/tools/widowhood-first-30-days',
    color: 'text-rose-700',
    bg: 'bg-rose-50 dark:bg-rose-950/30',
    badge: 'Checklist',
    ...
    time: '30 day plan',
    newThisMonth: true,
    keywords: 'widow widowed first 30 days spouse death loss checklist Social Security survivor benefits life insurance death certificate funeral seniors',
  },
  {
  ...
  {
    title: 'Memoir Prompt Generator',
    description: '40 thoughtful writing prompts across 8 themes to capture your life story. One prompt per day for three months builds a memoir.',
    icon: BookOpen,
    path: '/tools/memoir-prompt-generator',
    color: 'text-amber-700',
    bg: 'bg-amber-50 dark:bg-amber-950/30',
    badge: 'Reference',
    category: 'Life Planning',
    ...
    time: '15 min/day',
    newThisMonth: true,
    keywords: 'memoir life story writing prompts senior memory book StoryWorth Remento voice recording autobiography seniors',
  },
  {
    title: 'Accessible Travel Checklist',
    description: 'Pre-trip and on-trip checklist for older adults traveling with a wheelchair, walker, cane, or oxygen. Airline, hotel, equipment rental, and arrival.',
    icon: Plane,
    path: '/tools/accessible-travel-checklist',
    color: 'text-sky-700',
    bg: 'bg-sky-50 dark:bg-sky-950/30',
    badge: 'Checklist',
    category: 'Travel',
    ...
    time: 'Per trip',
    newThisMonth: true,
    keywords: 'accessible travel senior wheelchair walker cane oxygen POC airline TSA Cares hotel ADA Scootaround cruise',
  },
  {
    title: 'Senior Firearm Safety Checklist',
    description: 'Compassionate firearm safety + estate-planning checklist for older gun owners and families navigating cognitive decline. Respectful of ownership, focused on planning.',
    icon: Lock,
    path: '/tools/senior-firearm-safety-checklist',
    ...
    time: '20 min',
    newThisMonth: true,
    keywords: 'firearm gun safety senior dementia storage estate planning HoldMyGuns 988 suicide prevention veterans gun trust will',
  },
  {
    title: 'Gray Divorce Checklist',
    description: 'A dignified plan for divorce at 70+. QDRO retirement-asset division, Medicare gap, home decisions, beneficiary updates, and the year-one emotional rebuild.',
    icon: Scale,
    path: '/tools/divorce-at-70-checklist',
    color: 'text-slate-700',
    bg: 'bg-slate-50 dark:bg-slate-950/30',
    badge: 'Checklist',
    category: 'Life Planning',
  ...
  {
    title: 'Low-Vision Accessibility Quick Reference',
    description: 'Step-by-step instructions for enabling large text, magnifier, screen reader, and contrast on iPhone, iPad, Android, Windows, and Mac. Print and keep by your device.',
    icon: Eye,
    path: '/tools/low-vision-accessibility',
    color: 'text-blue-700',
    bg: 'bg-blue-50 dark:bg-blue-950/30',
    badge: 'Reference',
    category: 'Accessibility',
    ...
    time: '5 min',
    newThisMonth: true,
    keywords: 'low vision macular degeneration glaucoma accessibility iPhone iPad Android Windows Mac large text magnifier VoiceOver TalkBack high contrast seniors',
  },
  {
    ...
    <>
      <SEOHead
        ...
        jsonLd={{
          ...
          url: 'https://www.teksure.com/tools',
