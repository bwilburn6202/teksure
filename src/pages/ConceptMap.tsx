...
const NODES: MapNode[] = [
  ...
  { id: 'revenue',   label: 'Free Model',         group: 'revenue',   fx: 0.50, fy: 0.79, r: 24,
    desc: 'Everything on TekSure is free — no paywalls, no subscriptions' },
  { id: 'r-stripe',  label: 'Email Auth',        group: 'revenue',   fx: 0.37, fy: 0.92, r: 19,
    desc: 'Free accounts with email signup' },
  { id: 'r-prem',    label: 'Open Access',       group: 'revenue',   fx: 0.51, fy: 0.94, r: 19,
    desc: 'All guides, tools, and support are free for everyone' },
  { id: 'r-aff',     label: 'Community',         group: 'revenue',   fx: 0.65, fy: 0.92, r: 19,
    desc: 'Forum, referrals, and community-driven growth' },
