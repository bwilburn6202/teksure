      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">If you decide Costco isn&apos;t for you, ask for a full membership refund — even at end of year. They&apos;ll refund 100%. No fine print. Try it for a year, get money back if it didn&apos;t pay off.</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Costco does NOT offer a senior discount. AARP doesn&apos;t cover Costco. But Executive members spending $3,250+/year already get 2% back — that&apos;s effectively a senior-friendly discount for active shoppers.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
