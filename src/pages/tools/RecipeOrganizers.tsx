      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Use iPad on stand in kitchen with Paprika. Recipe + grocery list in one. Voice "Hey Siri, set timer 15 min" while hands floury. Kids can &quot;cast&quot; recipes to grandparents&apos; smart TV — read along together over video chat.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
