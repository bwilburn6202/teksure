      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Of all volunteer programs, Foster Grandparents may be the most rewarding for seniors who love children. You spend hours each week being a stable, loving presence for at-risk kids. Many seniors describe it as the most meaningful work of their lives. The small stipend covers transportation. Visit AmericorpsSeniors.gov to find a local Foster Grandparents program near you.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
