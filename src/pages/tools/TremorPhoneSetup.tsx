      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="font-semibold text-base mt-2">Touch accommodations:</p>
            ...
            <p className="font-semibold text-base">Bigger tap targets:</p>
            <ol className="list-decimal pl-5 space-y-1 text-base mb-3">
              <li>Settings → Display & Brightness → Display Zoom → "Larger Text".</li>
              <li>Settings → Display & Brightness → Text Size → max.</li>
            </ol>
            <p className="font-semibold text-base">Voice and dictation:</p>
