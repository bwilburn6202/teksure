      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Oura locks most insights behind a $5.99/month subscription after the first month. Over 5 years, that&apos;s $360 added to the $349 ring. Samsung Galaxy Ring and Ultrahuman are no-subscription. Worth the math.</p>
          </CardContent>
        </Card>
