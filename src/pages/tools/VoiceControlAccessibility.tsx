      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
          ...
          <>
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base mt-2 bg-muted/50 p-3 rounded">Once you\'re used to it, you can use your iPhone hands-free for everything.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Easier than full voice control. Just talk instead of type.</p>
