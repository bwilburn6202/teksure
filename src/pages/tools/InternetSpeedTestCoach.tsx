      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-3">Most accurate: stand near your router with a laptop or phone connected to your home Wi-Fi.</p>
            ...
            <p className="text-base mt-3">Both run a speed test in your browser. Free, no signup. Run it 2-3 times — different times of day, different rooms.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>Most senior households are over-paying.</strong> If you only have a TV, a phone or two, and check email — 25-50 Mbps is plenty. Consider downgrading.</p>
          </CardContent>
        </Card>
