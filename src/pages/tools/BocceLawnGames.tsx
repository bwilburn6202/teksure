      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">National Senior Games biennial — over 25 sports including bocce, horseshoes, cornhole. State qualifiers. Compete with peers. Lifetime memories. nsga.com. Most cities have monthly senior tournaments. Light competitive + social. Builds friendships. Free or low-cost.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
