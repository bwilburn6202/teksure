    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Best antennas</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Mohu Leaf ($30) — flat indoor</li><li>1byone outdoor ($60) — long range</li><li>Antop AT-410 ($90) — premium</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: $30 antenna saves $80/month vs cable. Pays for itself in 2 weeks.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
