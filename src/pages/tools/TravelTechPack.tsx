      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Shorter security line at the airport. Keep shoes, belt, and laptop on/in. Also keeps liquids and food in the bag. Saves 15-30 minutes per trip.</p>
            ...
            <p className="text-base mt-2 bg-muted/50 p-3 rounded"><strong>Quick Tip:</strong> Many credit cards (Chase Sapphire, Amex Platinum) reimburse the $77 fee. Check before paying.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">For international travel. Skips the customs line on the way home. Includes TSA PreCheck. Best deal if you fly abroad even once a year.</p>
            <ol className="list-decimal pl-5 space-y-1 text-base">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Free alternative to Global Entry for re-entering the US. Not as fast, but no fee.</p>
            <ol className="list-decimal pl-5 space-y-1 text-base">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2"><strong>Tip:</strong> Take a screenshot of the boarding pass too. If your battery dies, you can show the screenshot.</p>
          </CardContent>
        </Card>
