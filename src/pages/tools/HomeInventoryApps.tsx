      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">After a fire, theft, or flood — insurance asks for a list of what you owned, value, and proof. Without inventory, claims drop 40-60%. With photos and receipts — full payout.</p>
          </CardContent>
        </Card>
