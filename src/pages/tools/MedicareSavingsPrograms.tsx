      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground"><strong>SHIP</strong> — 1-877-839-2675. Free Medicare counseling. <strong>Eldercare Locator</strong> — 1-800-677-1116. <strong>BenefitsCheckUp.org</strong> — NCOA tool checks ALL benefits. Most seniors qualify for $5,000+/yr in benefits — apply.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
