      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">A special savings account. Money grows tax-free. Withdrawals tax-free if used for college (tuition, room/board, books, computers, even some K-12 private school).</p>
            <p className="text-base mt-2">Two flavors:</p>
