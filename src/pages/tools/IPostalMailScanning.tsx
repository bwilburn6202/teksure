      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Before paying for mail scanning, sign up free at USPS.com for Informed Delivery. Daily email shows envelope scans of mail arriving today. Combined with auto-pay for bills, eliminates 90% of mail concerns. Save iPostal1 ($10/month) for when you actually become a snowbird or full-time traveler.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
