    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Senior categories</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Time to Walk audio walks</li><li>Mindful Cooldown stretching</li><li>Yoga for beginners</li><li>Strength for older adults</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Apple One Family ($23/month) bundles Fitness+ with iCloud and Music for $13 less.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
