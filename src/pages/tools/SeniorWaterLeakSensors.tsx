    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Where to place</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Under the kitchen sink</li><li>Under bathroom sinks</li><li>Behind the toilet</li><li>By the water heater</li><li>Behind washing machine</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: A $40 sensor saved one senior $25,000 in flood damage. Cheapest insurance.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
