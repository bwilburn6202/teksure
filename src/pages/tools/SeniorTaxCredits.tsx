      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">If you\'re 65+, you get an additional $1,950 (single) or $1,550 (married, per spouse) added to the standard deduction. 2025 numbers:</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Income-based federal credit, $3,750 to $7,500. Mostly for retirees on Social Security with little other income. Check IRS Schedule R.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">If you ITEMIZE — medical expenses over 7.5% of income are deductible. Includes:</p>
            <ul className="list-disc pl-5 space-y-1 text-base mt-2">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">If 70.5+, you can send up to $105,000 from your IRA directly to charity. Counts toward Required Minimum Distribution but is TAX-FREE — better than donating cash and itemizing.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Almost every state offers SOMETHING for seniors:</p>
            ...
            <p className="text-base mt-3">Search "[your state] property tax senior" or call your county assessor.</p>
          </CardContent>
        </Card>
