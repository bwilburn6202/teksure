      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Tell your bank you&apos;re traveling. Land at your destination, use the airport ATM to get a few hundred in local currency. Use your credit card (no foreign fee type) for big purchases. Check rates on XE Currency app when you&apos;re unsure about prices. Never exchange money at the airport booth — that&apos;s how travelers lose 15% of their money instantly.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
