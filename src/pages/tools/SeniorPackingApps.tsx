    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Senior packing essentials</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>All medications (carry-on)</li><li>Phone charger</li><li>Power adapter (international)</li><li>Reading glasses backup</li><li>Compression socks</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Carry-on only saves $30+ per flight, no lost luggage.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
