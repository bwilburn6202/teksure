      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>Best practice:</strong> Use Google Maps as your default; switch to Waze for big city or rush-hour driving.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Once saved, you tap once and start driving — no typing.</p>
            <p className="font-semibold text-base mt-3">Apple Maps:</p>
            ...
            <p className="font-semibold text-base">Google Maps:</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="font-semibold text-base mt-2">iPhone — Find My (free, built in):</p>
            <ol className="list-decimal pl-5 space-y-1 text-base mb-3">
            ...
            <p className="font-semibold text-base">Google Maps — Location Sharing:</p>
            <ol className="list-decimal pl-5 space-y-1 text-base">
            ...
            <p className="text-base mt-3 bg-muted/50 p-3 rounded">When they share back, you'll see them on the map too. Useful for road trips ("how far away are you?").</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">No more "GPS lost" warnings in the mountains.</p>
            <p className="font-semibold text-base mt-3">Google Maps:</p>
            <ol className="list-decimal pl-5 space-y-1 text-base mb-3">
            ...
            <p className="font-semibold text-base">Apple Maps (iOS 17+):</p>
            <ol className="list-decimal pl-5 space-y-1 text-base">
