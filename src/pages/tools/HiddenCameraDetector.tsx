      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Hidden cameras in Airbnbs and short-term rentals are uncommon but documented. Most are dishonest hosts pointing cameras at "outdoor" areas that include private decks. A 5-minute sweep on arrival catches the obvious ones.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Most hidden cameras are placed where they get a clear view of:</p>
            <ul className="list-disc pl-5 space-y-1 text-base">
              <li>The bed.</li>
              <li>The shower area (through the bathroom door).</li>
              <li>The living room couch.</li>
            </ul>
            <p className="text-base mt-3 mb-2">Things to inspect:</p>
            <ul className="list-disc pl-5 space-y-1 text-base">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Most hidden cameras have an infrared (IR) light to see in the dark. Your phone\'s front camera CAN see IR. Test:</p>
            ...
            <p className="text-base mt-2 text-muted-foreground">Note: Apple iPhone front cameras filter IR, so this works better on Android. For iPhone, use the back camera with a TV remote pointed at it as a test (you should see a glow when you press buttons).</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Apps like <strong>Fing</strong> (free) scan a Wi-Fi network for connected devices. Sometimes you spot a "camera" device the host didn\'t mention. iOS\'s privacy makes this less effective; Android works fine.</p>
            <p className="text-base">Note: Modern hidden cameras can be 4G/cellular and not on Wi-Fi at all. So this finds some, not all.</p>
          </CardContent>
        </Card>
