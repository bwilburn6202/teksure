        ...
        {tab === 'iphone' && (
          <Card className="mb-4">
            <CardContent className="pt-6">
              ...
              <p className="text-base font-semibold mb-2">iPhone with Face ID (no Home button — most newer iPhones):</p>
              ...
              <p className="text-base font-semibold mb-2">iPhone with Home button (SE, older models):</p>
              ...
              <p className="text-base mt-4 bg-muted/50 p-3 rounded"><strong>Tip — back tap shortcut:</strong> Settings → Accessibility → Touch → Back Tap → Double Tap → Screenshot. Now you tap the back of your iPhone twice to take a screenshot. Game changer.</p>
            </CardContent>
          </Card>
        )}
        ...
        {tab === 'android' && (
          <Card className="mb-4">
            <CardContent className="pt-6">
              ...
              <p className="text-base font-semibold mb-2">Most Android phones:</p>
              <ol className="list-decimal pl-5 space-y-1 text-base mb-4">
              ...
              <p className="text-base font-semibold mb-2">Samsung Galaxy — extra option:</p>
              <ol className="list-decimal pl-5 space-y-1 text-base">
        ...
        {tab === 'mac' && (
          <Card className="mb-4">
            <CardContent className="pt-6">
              ...
              <p className="text-base mt-3">Screenshots save to your Desktop by default, named "Screen Shot [date].png".</p>
            </CardContent>
          </Card>
        )}
        ...
        {tab === 'windows' && (
          <Card className="mb-4">
            <CardContent className="pt-6">
              ...
              <p className="text-base mt-3">No PrtScn key? Open the "Snipping Tool" app from the Start menu — same idea.</p>
            </CardContent>
          </Card>
        )}
