      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Many senior men struggle with hiring lawn care — they&apos;ve always done it themselves. But fall risk, heat exhaustion, and physical strain make it unsafe. $30-$50/mow is tiny compared to ER visit. Hiring lawn care frees you for activities you actually enjoy. Smart use of retirement.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
