      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">90%+ of annuities sold to seniors are bad deals. High commissions (5-10% paid to salesman). Surrender charges 7-10 years. Complex riders that don&apos;t deliver. <strong>Few annuities make sense for most retirees.</strong></p>
          </CardContent>
        </Card>
