      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Average pipe burst pours 100 gallons/hour. By the time you find the shutoff in a panic, you have $5,000 in damage. Take 5 minutes today and learn where it is.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Each toilet, sink, washer, fridge has its OWN shutoff right behind/below it. For one fixture problem, you don&apos;t need the main shutoff.</p>
