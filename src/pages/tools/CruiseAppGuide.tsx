      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Most cruise apps include chat that works on the ship&apos;s wifi WITHOUT needing internet package:</p>
            ...
            <p className="text-base mt-2">Saves $100+ on internet packages just to text family. Connect via app on day 1.</p>
          </CardContent>
        </Card>
