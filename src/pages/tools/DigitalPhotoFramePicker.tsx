      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">A digital photo frame sits on a shelf or table, plugged into a wall outlet, connected to home Wi-Fi. Family members install a free app on their phones; when they take a photo, it can appear on the frame within seconds. No SD cards, no transferring files.</p>
          </CardContent>
        </Card>
