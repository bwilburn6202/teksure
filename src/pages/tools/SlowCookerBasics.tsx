      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground"><strong>The Magical Slow Cooker</strong> blog — large library. <strong>Pinterest</strong> — search "slow cooker recipes". <strong>Crock-Pot.com</strong> recipes from manufacturer. <strong>Skinnytaste</strong> — healthy slow cooker. All free + senior-friendly.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
