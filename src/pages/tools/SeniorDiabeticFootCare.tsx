    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Watch for</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Cuts that don&apos;t heal</li><li>Numbness or tingling</li><li>Color changes</li><li>Cracks in skin</li><li>Ingrown toenails</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Diabetic foot ulcers cause 80,000 amputations yearly. Daily check prevents.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
