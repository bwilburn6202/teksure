      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Companies like Ownwell, Reduce Property Tax handle appeals for 25-40% of first-year savings. No-cost-up-front. Worth it if you don&apos;t want hassle, or if first appeal lost. DIY is free though.</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Roughly 30-60% of property tax appeals succeed. Most are simple. Two hours of your time can save thousands of dollars over the years you stay in the house. Even if it doesn&apos;t work the first year, comparables change — try again next year.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
