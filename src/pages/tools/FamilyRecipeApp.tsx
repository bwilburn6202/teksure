...
const APPS: AppInfo[] = [
  {
    ...
    what: 'Built into every iPhone. Tap the camera icon in a note, point at the recipe card, and it saves a clean scan. Share the note with family in one tap.',
    whoFor: 'iPhone families wanting a free, no-extra-app way to capture handwritten cards.',
    cost: 'Free (built in)',
    pros: 'Already on the phone. Auto-crops the page. Shared notes update for everyone the moment one person edits.',
    cons: 'Works best across Apple devices. Search inside handwritten scans is limited.',
  ...
  },
  {
    ...
    what: 'A shared Google Doc that becomes your living family cookbook. Anyone can add a recipe, a photo, or a memory note about who first made it.',
    whoFor: 'Mixed-device families (iPhone + Android). Anyone wanting a printable book at the end.',
    cost: 'Free with a Google account',
    pros: 'Works on every phone and computer. Real-time edits. Print to PDF or order a bound book through a service like Lulu.',
    cons: 'Plain layout unless you spend time formatting. No built-in recipe tools (timers, scaling).',
  ...
  },
  {
    ...
    category: 'cookbook-builder',
    what: 'A paid recipe app that holds the whole family cookbook in one place. Type recipes in, scan cards with the built-in camera tool, and pull recipes from any website.',
    whoFor: 'Serious home cooks who want one organized library, meal plans, and grocery lists.',
    cost: 'About 5 dollars one-time per device',
    pros: 'No ads, no subscription. Optional cloud sync shares the cookbook across the family. Scales recipes up or down.',
    cons: 'You pay per platform (iPhone, Android, computer). Sharing across the family needs the optional cloud sync.',
  ...
  },
  {
    name: 'HappyCow',
    category: 'web-recipe',
    what: 'Finder app for vegetarian and vegan-friendly restaurants and grocery stores nearby. Useful when a family recipe needs a meatless swap or a hard-to-find ingredient.',
        ...
        <section className="bg-gradient-to-br from-rose-50 via-background to-amber-50 dark:from-rose-950/20 dark:to-amber-950/20 border-b border-border py-10 px-4">
          <div className="container max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              ...
              kitchen spill can erase a generation of cooking. Scan them this weekend.
            </p>
          </div>
        </section>
