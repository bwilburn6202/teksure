    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Eat more</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Fatty fish (salmon, sardines)</li><li>Berries (blueberries especially)</li><li>Nuts (walnuts)</li><li>Olive oil</li><li>Turmeric</li><li>Green tea</li></ul></CardContent></Card>
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Eat less</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Sugar</li><li>Processed meats</li><li>Refined carbs</li><li>Vegetable oils (corn, soy)</li><li>Trans fats</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Add berries to morning yogurt. One easy change. Real benefit.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
