          ...
          <>
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>Magnet (free or paid)</strong> — adds Windows-style snap features. Drag a window to the edge — it auto-resizes.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
          ...
          <>
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base mt-3 bg-muted/50 p-3 rounded">Or press <kbd className="bg-muted px-1.5 py-0.5 rounded">Win + Left/Right arrow</kbd>.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
