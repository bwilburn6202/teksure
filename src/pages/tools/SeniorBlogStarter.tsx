    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Topics seniors love</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Memoirs</li><li>Travel</li><li>Recipes</li><li>Genealogy</li><li>Career advice</li><li>Grandparenting</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Voice-typing makes blogging easier. Speak first, edit second.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
