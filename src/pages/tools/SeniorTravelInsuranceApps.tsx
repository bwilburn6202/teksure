    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">What to cover</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Trip cancellation</li><li>Medical & evacuation</li><li>Lost baggage</li><li>Pre-existing condition waiver</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Read the policy aloud — if a word is unclear, call and ask. Agents are paid to explain.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
