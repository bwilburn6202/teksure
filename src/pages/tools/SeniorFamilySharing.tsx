    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">What you can share</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>iCloud storage</li><li>Apple Music, TV+, Arcade</li><li>App purchases</li><li>Photos albums</li><li>Location</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Have grandkids set this up. They love teaching grandparents new tech.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
