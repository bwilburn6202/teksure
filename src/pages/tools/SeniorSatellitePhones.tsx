    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">When you need</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Hiking</li><li>Boating</li><li>Rural cabins</li><li>Long drives in remote areas</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: iPhone 14+ free 2-year satellite SOS. Worth upgrading for travel.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
