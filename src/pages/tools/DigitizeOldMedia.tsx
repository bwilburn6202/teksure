      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">VHS tapes lose magnetic signal — most are unwatchable after 25 years. Photo prints fade. Slides crack. The window to save these memories is closing. Once they're digital, they're permanent.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-3">You ship them a box. They digitize everything. They send back the originals plus a USB or cloud download.</p>
            ...
            <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>Tip:</strong> Mail with tracking and insurance. Schedule shipments for Q1 — companies are slammed near holidays.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Trickier than photos because you need a working VCR.</p>
            <ul className="list-disc pl-5 space-y-2 text-base">
