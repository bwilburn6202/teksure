      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">A USB cable carries both power AND data. In rare cases, a public USB port can be tampered with so plugging in your phone lets a hacker copy your photos, contacts, or install spy software.</p>
            <p className="text-base">The FBI warned about this in 2023. Real attacks are rare — but the fix is simple, so why risk it.</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Bring a small wall charger and a portable battery pack on every trip. You'll never need to use a sketchy public port — and your phone will last all day.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
