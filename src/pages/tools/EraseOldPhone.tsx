      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Old phones contain bank apps, photos, contacts, password managers, email. A buyer (or someone who finds a tossed phone) could access all of that. NEVER hand over a phone without wiping.</p>
          </CardContent>
        </Card>
        ...
        {tab === 'iphone' && (
          <Card className="mb-4">
            <CardContent className="pt-6">
              ...
              <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>If iPhone won\'t turn on</strong> — sign in to icloud.com/find from another device. Find your iPhone. "Erase This Device" → confirm. Then "Remove from Account".</p>
            </CardContent>
          </Card>
        )}
