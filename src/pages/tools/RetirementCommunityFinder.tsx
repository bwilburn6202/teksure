      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">A Place for Mom is FREE because communities pay them when you move in. They&apos;re not unbiased. Use them as ONE tool — but also research independently. Same with most "free" placement services.</p>
          </CardContent>
        </Card>
