      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
          ...
          <CardContent className="pt-6">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-base">Only EVER let people you know personally see your screen. Scammers ("Microsoft tech support", random pop-ups) will use these same tools to steal from you. Real family knows your stories. Real Microsoft and Apple do not call you.</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">If both of you have Apple devices, this is built in.</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>For full control:</strong> Install the free <strong>Google Family Link</strong> app — gives a trusted family member limited access. Or use TeamViewer (paid for business but free for family use).</p>
          </CardContent>
        </Card>
