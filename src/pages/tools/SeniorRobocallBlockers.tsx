    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Carrier free blockers</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>AT&amp;T ActiveArmor</li><li>Verizon Call Filter</li><li>T-Mobile Scam Shield</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Never press 1 to opt out — it confirms your number is real and brings more calls.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
