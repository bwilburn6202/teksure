      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Family recipes on index cards? Take photos. Type into Paprika or Notes. Add stories. Share with grandkids. Recipes vanish faster than people. Save them while you&apos;re here to explain "a pinch of salt".</p>
          </CardContent>
        </Card>
