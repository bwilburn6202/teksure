      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">In your TAXABLE brokerage account, sell investments that LOST value. Use the loss to offset capital gains, OR up to $3,000/year against ordinary income. Buy similar (NOT identical) investment to maintain market exposure.</p>
          </CardContent>
        </Card>
