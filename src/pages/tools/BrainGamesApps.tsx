...
const PICKS: Pick[] = [
  {
    ...
    pros: [
      'Truly free — one puzzle per day in any browser, no account needed.',
      'Short and finite. No infinite scroll, no notifications.',
      'Great as a daily phone or text chat with family ("got it in 3!").',
    ],
  ...
  },
  {
    ...
    pros: [
      'Fresh letters every day — find as many words as you can.',
      'Free version lets you play the first few words of the day.',
      'NYT Games bundle also unlocks Crossword, Connections, Strands.',
    ],
  ...
  },
  {
    ...
    pros: [
      'Hundreds of themed crossword packs — Planet Earth, Inventions, Medieval Times.',
      'Plays well on iPad in landscape mode.',
      'No subscription required to keep playing.',
    ],
  ...
  },
  {
    ...
    pros: [
      'Daily set of 3-5 short games covering memory, attention, math.',
      'Tracks progress over time with charts.',
      'Free tier gives you a real taste before paying.',
    ],
    cons: [
      'Got a $2M FTC fine in 2016 for overstating brain-health claims — see the warning below.',
      'Subscription is pricey for what is, honestly, a set of mini-games.',
    ],
  ...
  },
  {
    ...
    pros: [
      'Strong focus on language and communication, not abstract puzzles.',
      'Apple App of the Year — polished, calm interface.',
      'Daily 10-15 minute session feels achievable.',
    ],
  ...
  },
  {
    ...
    pros: [
      'Bigger free tier than Lumosity or Elevate.',
      'Cheerful, colorful design — fun rather than clinical.',
      'Family-tournament feature if multiple people in the house play.',
    ],
  ...
  },
  {
    ...
    pros: [
      'Sudoku.com app is free with ads, has 4 difficulty levels, daily challenge.',
      'AARP runs a free daily crossword at games.aarp.org.',
      'NYT Mini Crossword is free every day in a browser — 5 minutes, done.',
    ],
  ...
  return (
    <>
      <SEOHead
        ...
        description="Honest comparison of brain games and cognitive apps — Wordle, NYT Spelling Bee, CodyCross, Lumosity, Elevate, Peak, Sudoku.com. Free vs paid. What helps, what hypes."
      ...
      <main className="min-h-screen bg-background">
        <section className="bg-gradient-to-br from-violet-50 via-background to-purple-50 dark:from-violet-950/20 dark:to-purple-950/20 border-b border-border py-10 px-4">
          <div className="container max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Seven honest picks — from free Wordle to paid Lumosity. We pick fun first, hype last.
            </p>
          </div>
        </section>
        ...
        <div className="container max-w-3xl mx-auto px-4 py-8">
          ...
          <Card className="border-border bg-muted/30 mb-6">
            <CardContent className="p-5">
              <p className="text-sm font-semibold mb-2">Honest note before you start</p>
              <p className="text-xs text-muted-foreground">
                The science on whether brain-training apps prevent dementia is mixed at best. A large 2014 review and the FTC's own findings say there is no strong proof these apps slow cognitive decline. What IS proven to help your brain: sleep, walking, socializing, treating high blood pressure, and learning genuinely new skills (a language, an instrument, a craft). Pick a brain game because it is FUN — not because it is medicine. A 5-minute daily Wordle with your grandkid is worth more than a $130 yearly subscription you stop opening.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="space-y-4 mb-6">
            ...
            {!showAll && (
              <Button variant="outline" onClick={() => setShowAll(true)}>Show all 7 picks</Button>
            )}
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-border">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              <Link to="/tools/library-power-pack" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Free books, audiobooks, and learning from your library card.</p>
              </Link>
              <Link to="/tools/senior-friendly-apps" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Calm, large-text apps worth keeping on your phone.</p>
              </Link>
              <Link to="/tools/podcast-starter" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Free listening that keeps your mind engaged on walks.</p>
              </Link>
            </div>
          </div>
