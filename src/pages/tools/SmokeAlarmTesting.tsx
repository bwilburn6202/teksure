      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Single chirp every 30 seconds = battery low. Replace battery (or whole alarm if 10+ years old). If chirp continues after new battery — alarm is dead. Replace.</p>
          </CardContent>
        </Card>
