      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground"><strong>Pet therapy visits</strong> — Pet Partners, Therapy Dogs International. Free pet visits to nursing homes/senior centers. <strong>Robotic pets</strong> — Joy For All Companion. Hasbro $130. Realistic for those with dementia. <strong>Volunteer at shelter</strong> — pet time without owning.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
