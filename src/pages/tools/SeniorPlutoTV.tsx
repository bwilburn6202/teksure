    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Senior content</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Classic Doctor Who</li><li>Old Westerns</li><li>I Love Lucy</li><li>MASH episodes</li><li>News in real time</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Pluto TV is great backup if regular subscription has issues.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
