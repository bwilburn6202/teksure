...
const terms: Term[] = [
  ...
  { word: 'Spam', definition: 'Unwanted messages sent in bulk, usually by email — often trying to sell you something or trick you.', example: 'Those emails offering you millions of pounds from a stranger are spam.' },
