      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">The pros\' rule for protecting important data:</p>
            ...
            <p className="text-base mt-2">Sounds complicated. It isn\'t — most of this happens automatically.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">If your house has a fire or flood, the local backup drive is destroyed too. You need a copy somewhere else. Three approaches:</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2 text-muted-foreground">Don\'t bother backing up: installed programs (just re-install), system files, downloads folder.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Pick one photo from 2 years ago. Find it in your backup. Restore it to a new folder. If it works — your backup works. If it doesn\'t — fix it before you need it.</p>
          </CardContent>
        </Card>
