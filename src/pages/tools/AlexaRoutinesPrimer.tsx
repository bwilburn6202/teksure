      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">A routine bundles multiple actions under one phrase. Say "Alexa, good morning" and she turns on lights, reads the news, gives weather, and starts your coffee — all from one command.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">$20/month. Adult kids get an app showing parent activity (echo activity, no audio). Includes 24/7 emergency response button + fall detection support. Removes "I don&apos;t want to bother them" guilt while keeping family connected.</p>
          </CardContent>
        </Card>
