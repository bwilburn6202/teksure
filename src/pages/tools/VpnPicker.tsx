      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">An app that routes your internet traffic through a private "tunnel". Hides what you do from your internet provider, hotel Wi-Fi, public hotspots. Also hides your location — useful for accessing region-locked content or for some kinds of privacy.</p>
          </CardContent>
        </Card>
          ...
          {VPNS.map(v => (
            <Card key={v.name}>
              <CardContent className="pt-6">
                ...
                <p className="text-base mb-1">{v.best}</p>
        ...
        <Card className="mb-4 border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Many "free" VPNs sell your data, inject ads, or ARE the threat. Free options to TRUST: Proton VPN free tier, Apple\'s iCloud Private Relay. Avoid no-name free apps in the App Store.</p>
          </CardContent>
        </Card>
