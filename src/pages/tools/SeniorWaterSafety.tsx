      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">For $30, buy a Govee 2-pack water sensor at Amazon. Place one under the kitchen sink, one near the washing machine. Loud beep when water detected. The $30 could save you a $10,000+ insurance claim. Many seniors who&apos;ve had floods say the only thing they wish they&apos;d done sooner is install these sensors.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
