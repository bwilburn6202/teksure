      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Home warranties (American Home Shield, Choice, Cinch, etc.) cover repairs to appliances and home systems. Most consumer studies show they pay out less than premiums. Better Business Bureau ratings tend to be poor. <strong>Self-insurance (savings account) usually beats them.</strong></p>
          </CardContent>
        </Card>
