    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Sell for cash</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Apple Trade-In</li><li>Samsung Trade-In</li><li>Decluttr.com</li><li>Best Buy trade-in</li><li>Amazon Trade-In</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Old iPhones often worth $100-$200. Check Apple Trade-In before recycling.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
