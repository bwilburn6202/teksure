      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Caregiver burnout leads to depression, illness, and worse outcomes for the person being cared for. Respite — even a few hours a week — improves both lives. Most caregivers don&apos;t take respite because they don&apos;t know where to find it.</p>
          </CardContent>
        </Card>
