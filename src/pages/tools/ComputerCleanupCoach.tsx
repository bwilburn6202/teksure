          ...
          <>
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base">Apple menu → Restart. Macs are great about staying on for weeks but they DO need a restart now and then. Often instantly fixes slowness.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
            ...
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base">System Settings → General → Software Update. Updates fix bugs that slow you down.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
                <h3 className="font-bold text-lg mb-3">5. Run a free virus scan</h3>
                <p className="text-base">Macs aren't immune. Install <strong>Malwarebytes for Mac</strong> (free) — scan once a month.</p>
              </CardContent>
            </Card>
          </>
        )}
          ...
          <>
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base">Start menu → Power → Restart. Windows performance often degrades after a few days; a restart fixes 70% of slow-computer complaints.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
            ...
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base">Settings → Windows Update → "Check for updates". Run all of them. Restart when asked.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
