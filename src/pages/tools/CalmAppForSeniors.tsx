      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Both Calm and Headspace offer free trials. Try a week of each. Pick the voice + style that resonates. The $70/year is reasonable if you use daily for sleep + stress. Many seniors say these apps changed bedtime ritual for the better. Start with sleep stories — proven to help insomnia.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
