    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">YouTube channels</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>SilverSneakers official</li><li>Senior Fitness With Meredith</li><li>HASfit Senior</li><li>Yes2Next (chair yoga)</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Place a sturdy chair (no wheels) in living room. Reminds you to do daily exercises.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
