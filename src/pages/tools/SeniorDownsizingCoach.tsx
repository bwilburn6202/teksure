      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">A profession dedicated to helping seniors downsize. They sort, donate, sell, pack, supervise movers, set up the new home — sometimes within days. Average $50-90/hour but worth it for many.</p>
            <p className="text-base mt-2">Find one at <strong>nasmm.org</strong> — National Association of Senior Move Managers. Members are vetted and insured.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2">Save donation receipts for tax deduction (if you itemize).</p>
          </CardContent>
        </Card>
