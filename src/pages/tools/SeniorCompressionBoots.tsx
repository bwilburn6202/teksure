    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Best for</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Edema (swollen ankles)</li><li>Tired legs after standing</li><li>Poor circulation</li><li>Diabetes (consult doctor)</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: 20 minutes daily reduces swelling for many seniors.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
