      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">The average US cell bill is $144/month. Most people on Verizon, AT&T, or T-Mobile premium plans pay $80-$100/line. Switching to one of the picks below cuts that to $20-40/line on the SAME networks.</p>
          </CardContent>
        </Card>
