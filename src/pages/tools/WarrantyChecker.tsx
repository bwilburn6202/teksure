...
const warrantyData: Partial<Record<Brand, Partial<Record<DeviceType, WarrantyInfo>>>> = {
  ...
  samsung: {
    phone: {
      ...
      repairUrl: 'https://www.samsung.com/uk/support/service-centre/',
      repairUrlLabel: 'Find a Samsung Service Centre',
      ...
      importantNotes: [
        ...
        'Samsung authorised service centres maintain your warranty; third-party repairs may not',
      ],
    },
    tablet: {
