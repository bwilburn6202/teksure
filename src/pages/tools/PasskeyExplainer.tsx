      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">A passkey replaces a password with your face, fingerprint, or phone PIN. The "key" is stored on your device. Sites verify it without you ever typing a password. <strong>Cannot be phished. Cannot be guessed. Cannot be reused on another site.</strong></p>
          </CardContent>
        </Card>
