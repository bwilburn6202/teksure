    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Best sources</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Eggs (6g each)</li><li>Greek yogurt (15g/cup)</li><li>Cottage cheese (28g/cup)</li><li>Salmon (25g/4oz)</li><li>Beans (15g/cup)</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Greek yogurt + protein shake = 45g protein in 10 minutes.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
