      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Encrypts your hard drive. Without your password, the data is unreadable — even if someone removes the drive and connects it to another computer. Free, built-in to Mac and Windows. No noticeable slowdown on modern computers.</p>
            <p className="text-base mt-2"><strong>iPhone, iPad, Android phones</strong> are encrypted by default. Just have a passcode set.</p>
          </CardContent>
        </Card>
        ...
        {tab === 'mac' && (
          <Card className="mb-4">
            <CardContent className="pt-6">
              ...
              <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>If you forgot your password</strong> — sign in with your Apple ID at the login screen.</p>
            </CardContent>
          </Card>
        )}
        ...
        {tab === 'windows' && (
          <Card className="mb-4">
            <CardContent className="pt-6">
              ...
              <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>Windows Home edition</strong> uses "Device Encryption" — same idea, simpler. Sign in with Microsoft account → Settings → "Device Encryption" → ON.</p>
            </CardContent>
          </Card>
        )}
        ...
        <Card className="mb-4 border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">If you forget your password AND lose your recovery key — your data is gone. No "I forgot" recovery service exists. PRINT the recovery key. Put it in a safe deposit box, with your will, or with a trusted family member.</p>
          </CardContent>
        </Card>
