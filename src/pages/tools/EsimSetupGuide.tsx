      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-3">A SIM card is the tiny chip that connects your phone to your carrier (Verizon, T-Mobile, AT&T). For decades it's been a small plastic card you slide into the phone.</p>
            <p className="text-base mb-3"><strong>eSIM ("embedded SIM")</strong> replaces that little card with a digital version built into your phone. There's nothing to slide in — your carrier sends you a QR code or activation, and your phone is connected.</p>
            <p className="text-base">All iPhones sold in the US since the iPhone 14 (2022) are eSIM-only — no physical SIM slot. Most newer Android phones support eSIM too.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <ul className="text-base space-y-2 list-disc pl-5">
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-3"><strong>If your phone is brand new from the carrier:</strong> It comes pre-activated. Just turn it on and follow the prompts.</p>
            <p className="text-base mb-2"><strong>Switching from a different phone:</strong></p>
            ...
            <p className="text-base"><strong>Carrier-provided QR codes:</strong> Verizon, AT&T, and T-Mobile all let you request one in their app, by phone, or in store.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3">If your carrier app has a "Set up eSIM" button, that's the easiest path — let the app guide you.</p>
          </CardContent>
        </Card>
