      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Instead of one router struggling to reach every room, you put 2 or 3 small units around the house. They "talk" to each other and create one big Wi-Fi network. Your phone or laptop automatically connects to whichever is closest. No more dead zones.</p>
          </CardContent>
        </Card>
          ...
          <>
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base bg-muted/50 p-3 rounded">{recs[size].note}</p>
              </CardContent>
            </Card>
