  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Cheap alternative</h2><ul className="list-disc pl-5 space-y-2 text-sm"><li>$15 regular feeder.</li><li>Wyze Cam $30 nearby.</li><li>Senior cheaper.</li><li>DIY smart.</li><li>Less smooth.</li><li>Works.</li></ul></CardContent></Card>
