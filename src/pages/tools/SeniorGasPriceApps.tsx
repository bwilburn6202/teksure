    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Gas savings tips</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Fill mid-week (Tue-Wed cheapest)</li><li>Avoid premium unless required</li><li>Properly inflated tires save 3%</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Spending $100/week on gas? GasBuddy saves $5/week — $260/year.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
