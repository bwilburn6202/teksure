      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2">A retiree volunteering 100 miles/month for charity = $168/year deduction. A self-employed retiree driving 5,000 business miles = $3,500 deduction.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2">IRS requires "contemporaneous" log — written at time of travel, not reconstructed later. Apps do this automatically.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Drive for Meals on Wheels, church, Red Cross? You can deduct 14¢/mile if you itemize. Save documentation that you drove for the charity (the charity will provide a confirmation letter).</p>
          </CardContent>
        </Card>
