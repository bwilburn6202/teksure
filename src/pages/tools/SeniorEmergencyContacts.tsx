    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Best contacts</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Adult child or spouse</li><li>Backup family member</li><li>Doctor or healthcare proxy</li><li>Lawyer</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Test SOS shortcut once. iPhone hold side+volume buttons.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
