    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">When seniors need one</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Hotel Wi-Fi</li><li>Coffee shop / library</li><li>Banking on travel</li><li>Watching US Netflix abroad</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Avoid free VPNs that aren&apos;t Proton. Many sell your data — defeats the purpose.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
