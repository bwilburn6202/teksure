    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Red flags</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>&ldquo;Loves&rdquo; you in 1 week</li><li>Won&apos;t video call</li><li>Always too busy/abroad to meet</li><li>Asks for money for emergency</li></ul></CardContent></Card>
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Common stories</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Military deployed</li><li>Doctor in Africa</li><li>Oil rig worker</li><li>Stuck in customs</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Real love is patient. Anyone rushing to &ldquo;love&rdquo; in days is suspicious.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
