      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Every 20 minutes, look at something 20 feet away for 20 seconds. Most-recommended eye care rule. Set a phone timer first 2 weeks until habit forms.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">See eye doctor if eye strain is paired with:</p>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Best eye-strain fix is the right prescription. Many seniors push glasses 3-5 years. Annual exam catches gradual changes you don&apos;t notice. See /tools/eye-exam-apps.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
