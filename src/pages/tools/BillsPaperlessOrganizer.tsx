      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">For each bill (electric, gas, water, internet, phone, insurance, credit cards, banks):</p>
            ...
            <p className="text-base mt-2 text-muted-foreground">Keep paper for: tax-related (statements you\'d need for taxes), legal documents, deeds, original wills.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Inside Gmail or Outlook, make a folder called "Bills". Set up rules so every bill email auto-files there:</p>
            <ol className="list-decimal pl-5 space-y-1 text-base">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Set autopay for fixed-amount bills:</p>
            ...
            <p className="text-base mt-2">Don\'t autopay variable bills you want to review (electric, water) — just calendar a "pay bills" hour each month.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Make a "Tax 2025" folder in iCloud, Google Drive, or OneDrive. Throughout the year, drop in:</p>
            ...
            <p className="text-base mt-2">Come tax time — open the folder, all there.</p>
          </CardContent>
        </Card>
