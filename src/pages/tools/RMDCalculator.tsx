      ...
      <div className="max-w-xl mx-auto px-4 py-8">
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-3xl font-bold text-foreground">RMD Calculator</h1>
          </div>
          <p className="text-muted-foreground text-lg">Required Minimum Distribution from your traditional IRA or 401(k).</p>
        </div>
        <Card>
          <CardContent className="py-6 px-4 space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-base font-medium text-foreground">Your age this year</label>
              ...
              <div>
                <label className="text-base font-medium text-foreground">Dec 31 balance ($)</label>
            ...
            {valid && (
              <div className="text-center bg-success border border-success-foreground/25 rounded-md py-4 px-3 space-y-2">
                <p className="text-base text-success-foreground">Estimated RMD for this year</p>
                <p className="text-4xl font-bold text-success-foreground">{fmt(rmd)}</p>
                <p className="text-sm text-success-foreground mt-2">Balance ÷ life expectancy factor of {factor} (IRS Uniform Lifetime Table)</p>
              </div>
            )}
            {a < 73 && age && <p className="text-base text-muted-foreground">RMDs begin at age 73 (SECURE 2.0 Act).</p>}
          </CardContent>
        </Card>
        <Card className="mt-4 bg-warn border-warn-foreground/25">
