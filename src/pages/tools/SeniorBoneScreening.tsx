    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">T-score</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Above -1.0: normal</li><li>-1.0 to -2.5: osteopenia</li><li>Below -2.5: osteoporosis</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Don&apos;t skip DEXA. Catches osteoporosis silently progressing.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
