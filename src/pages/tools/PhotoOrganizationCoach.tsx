      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="font-semibold text-base mt-2">Find duplicates (saves storage):</p>
            ...
            <p className="font-semibold text-base">Group by person:</p>
            <ol className="list-decimal pl-5 space-y-1 text-base mb-3">
            ...
            <p className="font-semibold text-base">Search by anything:</p>
            <p className="text-base">Type "beach" or "dog" or "Christmas 2019" in the search bar. iPhone reads photo content automatically.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="font-semibold text-base mt-2">Auto-organize:</p>
            <p className="text-base mb-2">Google Photos automatically:</p>
            ...
            <p className="font-semibold text-base">Free up space:</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Best gift for grandparents who live far away:</p>
            <p className="font-semibold text-base">iCloud (Apple users):</p>
            <ol className="list-decimal pl-5 space-y-1 text-base mb-3">
            ...
            <p className="font-semibold text-base">Google Photos (cross-platform):</p>
            <ol className="list-decimal pl-5 space-y-1 text-base">
