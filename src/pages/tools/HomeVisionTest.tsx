...
const VISION_TESTS: HomeTest[] = [
  {
    ...
    how: [
      ...
      'Hold the phone at the distance the app shows on screen (usually 16 inches).',
      'Cover one eye and read the letters or shapes the app displays.',
      'Repeat for the other eye.',
      'Save your result so you can compare it after a few months.',
    ],
  ...
  },
  {
    ...
    what: 'A small plastic eyepiece that clips onto your phone screen. Walks you through a refraction test that estimates a glasses prescription. Used by over 1 million people.',
    how: [
      'Order the EyeQue VisionCheck from eyeque.com (about $30).',
      'Download the EyeQue app and create a free account.',
      'Clip the eyepiece over your phone screen and follow the on-screen prompts.',
      'Tilt the phone until two colored lines line up — repeat for 9 angles, both eyes.',
  ...
  },
  {
    ...
    cost: 'Free — printable',
    what: 'A simple square grid with a dot in the middle. Used by eye doctors for over 75 years to spot early signs of age-related macular degeneration (AMD), the leading cause of vision loss after 60.',
    how: [
      'Print the grid from the American Academy of Ophthalmology site (link below).',
      'Tape it to a wall at eye level, 14 inches away in good light.',
      'Wear your reading glasses if you use them. Cover one eye.',
      'Stare at the center dot. The grid lines around it should look straight and even.',
...
const HEARING_TESTS: HomeTest[] = [
  {
    ...
    cost: 'iPhone and Android — free',
    what: 'A 6-minute hearing screening that gives you a personal hearing profile. Built with audiologists and used by Beyerdynamic and Loewe TVs to tune sound to your ears.',
    how: [
  ...
  },
  {
    ...
    how: [
      'Open hearingtracker.com on your phone or computer.',
      'Click the free Online Hearing Test button on the home page.',
      'Plug in headphones (wired works best) in a quiet room.',
      'Listen for tones at different pitches and tap when you hear each one.',
      'You get an audiogram-style chart you can email to yourself or a doctor.',
    ],
    link: 'https://www.hearingtracker.com/online-hearing-test',
  },
  {
    name: 'AARP free hearing test',
    cost: 'Free — phone or web (AARP membership not required for the test)',
    ...
    how: [
      'Visit nationalhearingtest.org or call 1-866-223-7575.',
      'Use the free access code from the AARP hearing-test page (renews every six months).',
      'Wear headphones or hold the phone to your ear in a quiet spot.',
      'Repeat the numbers you hear — the test grades each ear separately.',
        ...
        <section className="bg-gradient-to-br from-blue-50 via-background to-green-50 dark:from-blue-950/20 dark:to-green-950/20 border-b border-border py-10 px-4">
          <div className="container max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto">
              Free and low-cost tests you can run on your phone, in plain English. A first check before you book an appointment.
            </p>
          </div>
        </section>
        ...
        <div className="container max-w-3xl mx-auto px-4 py-8">
            ...
            <CardContent className="p-5 flex gap-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-muted-foreground">
                  Every test on this page is a screening. They give you a hint about whether something is off — they cannot replace a real eye doctor or audiologist. If a test shows a concern, if your vision changes suddenly, if you see flashes or floaters, if you have ear pain, ringing, or sudden hearing loss in one ear, please book an in-person appointment that week. A home test is a starting point, not the answer.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-border bg-muted/30 mb-6">
            <CardContent className="p-5">
              ...
              <ul className="space-y-1.5 text-xs text-muted-foreground">
                ...
                <li className="flex gap-2"><span className="text-primary">•</span><span>Wavy lines on the Amsler grid or missing letters on a vision app — book an ophthalmologist, not only an optometrist.</span></li>
          ...
          <div className="mt-10 pt-8 border-t border-border">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              <Link to="/tools/hearing-aid-apps" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                <p className="font-medium text-sm">Hearing Aid Apps & OTC Aids</p>
                <p className="text-xs text-muted-foreground mt-0.5">Free tests and a picker for over-the-counter aids.</p>
              </Link>
              <Link to="/low-vision-setup" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Make your phone and computer easier to read.</p>
              </Link>
