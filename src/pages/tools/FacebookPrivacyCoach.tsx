      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">By default, Facebook shows your photos, friends list, hometown, family members, and recent posts to anyone. Scammers harvest this info for targeted scams ("I see your daughter Sarah just had a baby — I need to send her a gift!").</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Facebook changes settings often. Run Privacy Checkup once a year. Pick a date — Memorial Day, your birthday, January 1st. 5 minutes. Big peace of mind.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
