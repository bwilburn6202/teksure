      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2">All require a current prescription (under 1-2 years old). Get prescription from any optometrist — they MUST give it to you (federal law).</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">PD = Pupillary Distance. Online glasses sites need it. The optometrist may not include it on the prescription. Options:</p>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Glaucoma, macular degeneration, cataracts often have NO symptoms until late. Annual eye exam covered by Medicare for diabetes, high-risk glaucoma. Otherwise out-of-pocket $50-150. Worth it.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
