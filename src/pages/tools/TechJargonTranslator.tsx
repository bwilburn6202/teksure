...
const DICTIONARY: DictTerm[] = [
  ...
  { term: 'URL', category: 'Internet', definition: 'The address of a web page — the thing that starts with "https://".', example: 'https://www.teksure.com/tools is a URL.', related: ['HTTPS', 'Browser'] },
