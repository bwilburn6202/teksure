      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Microsoft retired Skype in 2025 after over 20 years. They\'re moving everyone to Microsoft Teams. Many people who relied on Skype for international calls or video chats are stuck. Below is what works.</p>
          </CardContent>
        </Card>
