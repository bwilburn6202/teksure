      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Original Medicare leaves you on the hook for 20% of Part B costs (no cap). Medigap fills these "gaps". Standardized lettered plans (A-N) — same benefits no matter who sells.</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Medicare costs change every year. Check Plan G quotes annually — sometimes save $40-100/mo by switching insurer. SHIP counselors do this free.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
