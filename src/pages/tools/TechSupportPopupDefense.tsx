      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 border-destructive">
          <CardContent className="pt-6">
            ...
            <p className="text-base">No matter what the pop-up says, do not call. The number is NOT Microsoft, NOT Apple, NOT McAfee. It goes to a scam call center where they'll convince you to install remote-control software, then drain your bank account.</p>
            <p className="text-base mt-2">Microsoft and Apple <strong>never</strong> show pop-ups telling you to call them.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="font-semibold text-base mt-2">If the pop-up locks the browser:</p>
            ...
            <p className="text-base">When the browser opens again, it might offer to "restore tabs" — say <strong>NO</strong>. That re-opens the bad page.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="font-semibold text-base mt-2">Chrome / Edge:</p>
            ...
            <p className="font-semibold text-base">Safari:</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">In most cases, this kind of pop-up is just a scary website — your computer doesn't have an actual virus. But run a scan to be sure.</p>
            <p className="font-semibold text-base mt-3">Mac:</p>
            <ul className="list-disc pl-5 space-y-1 text-base mb-3">
