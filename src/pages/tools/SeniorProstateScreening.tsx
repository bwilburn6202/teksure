    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Symptoms to watch</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Frequent urination</li><li>Weak stream</li><li>Blood in urine</li><li>Bone pain</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Discuss screening with doctor. Personal decision based on your health.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
