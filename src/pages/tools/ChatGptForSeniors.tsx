      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">ChatGPT is a free website (and app) where you type a question and an AI writes an answer in seconds. Like a 24/7 patient assistant. It can also speak out loud and listen to your voice.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Bad: "How do I lose weight?"</p>
            <p className="text-base">Good: "I&apos;m 72, have arthritic knees, walk 30 min/day. What 3 small diet changes can help me lose 10 pounds in 3 months?"</p>
            <p className="text-base mt-2">More context = much better answer.</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">First ChatGPT question is the hardest. Open it, type "Tell me a joke about cats", and you&apos;re started. After 5 questions, you&apos;ll know what it&apos;s good at — and bad at.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
