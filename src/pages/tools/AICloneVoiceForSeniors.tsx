  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">iPhone Personal Voice</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>iOS 17+.</li><li>15-min voice training.</li><li>Senior preserve voice.</li><li>For ALS or losing voice.</li><li>Read with your voice.</li><li>Free.</li></ul></CardContent></Card>
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Voice clone scams</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>Scammers clone family.</li><li>&quot;Grandkid in jail.&quot;</li><li>Senior major risk.</li><li>Code word with family.</li><li>Hang up + call back.</li><li>Verify direct.</li></ul></CardContent></Card>
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Family safe word</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>Pick word — &quot;blueberry.&quot;</li><li>Real family knows.</li><li>Scammer fails.</li><li>Senior verifying.</li><li>Free + life-saving.</li><li>Discuss family.</li></ul></CardContent></Card>
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Memorial voice</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>Loved one passing.</li><li>Record voice memos now.</li><li>Senior preserve voice + stories.</li><li>Free Voice Memos app.</li><li>Treasure forever.</li><li>Don&apos;t wait.</li></ul></CardContent></Card>
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">ElevenLabs</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>Pro voice cloning.</li><li>$5-$22/month.</li><li>Senior memoir audiobook.</li><li>From your voice.</li><li>Trial free.</li><li>Powerful.</li></ul></CardContent></Card>
