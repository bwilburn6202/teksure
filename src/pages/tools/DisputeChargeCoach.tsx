      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Under the Fair Credit Billing Act (1974) and Truth in Lending Act, you can dispute charges and not pay them while disputed. Banks usually credit your account immediately. Credit card protection is FAR stronger than debit card.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4 border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Debit cards have weaker protection (Electronic Fund Transfer Act). Money is OUT of your account during dispute. ALWAYS use credit card for online or unfamiliar purchases.</p>
          </CardContent>
        </Card>
