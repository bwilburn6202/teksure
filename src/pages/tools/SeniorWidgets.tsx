    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Best for seniors</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Weather (today + week)</li><li>Calendar (today&apos;s events)</li><li>Reminders</li><li>Family photo (rotates)</li><li>Battery level</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Replace one app icon with weather widget. Useful info always visible.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
