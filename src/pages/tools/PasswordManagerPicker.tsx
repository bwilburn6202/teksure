      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Re-using the same password across accounts is the #1 cause of getting hacked. When ANY website you use leaks passwords (and they all do eventually), the hackers try those passwords on every other site. A password manager generates a unique, strong password for each account, and remembers them for you.</p>
            <p className="text-base mt-2"><strong>You only need to remember ONE password</strong> — the master password to the manager. That\'s it.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">If something happens to you, your spouse or adult child needs access. Every good password manager has this.</p>
            ...
            <p className="text-base mt-2">Set up a 7-day waiting period — they request access, you have a week to deny if it\'s a mistake. After that, they can read your passwords.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4 border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">It\'s OK as a starting point. But every site needs a UNIQUE password. Most retired adults have 50-100 online accounts; a notebook can\'t keep up. The password manager lets you generate fresh strong passwords as you go — without typing them.</p>
          </CardContent>
        </Card>
