    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
          ...
          <>
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base mt-3">Doesn\'t work? Apple has an "Account Recovery" process that takes a few days. Apple is very strict to protect from imposters — they\'ll ask many questions.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
          ...
          <>
            <Card className="mb-4">
              <CardContent className="pt-6">
                ...
                <p className="text-base mt-3">The more recovery info you set up beforehand, the easier this is.</p>
              </CardContent>
            </Card>
            <Card className="mb-4">
              <CardContent className="pt-6">
        ...
        <Card className="mb-4 border-warn-foreground/25 ">
          <CardContent className="pt-6">
            <h2 className="font-bold text-xl mb-3"> Recovery scams</h2>
            <p className="text-base mb-2">Real Apple and Google will NEVER:</p>
            ...
            <p className="text-base mt-2">If a stranger calls saying "your Apple ID was hacked, let me help you" — hang up. You\'re being scammed.</p>
          </CardContent>
        </Card>
