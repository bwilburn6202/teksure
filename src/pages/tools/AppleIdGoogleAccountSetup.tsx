      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Write down (offline, in a safe place):</p>
            ...
            <p className="text-base mt-2">If you\'re ever incapacitated or pass, your family will need this information to access photos, contacts, and important documents.</p>
          </CardContent>
        </Card>
