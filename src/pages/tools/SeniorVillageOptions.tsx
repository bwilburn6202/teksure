      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Self-organized member-led neighborhood network. Started in Boston 2002. 350+ villages across US. Members 60+ pay annual dues ($300-800/yr). Get help from neighbors + vetted vendors. Stay in own home longer.</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Visit a village event before joining. Most welcome guests at one or two open events. Meet members. See vibe. Then decide. $300/yr is small — but commitment to community is meaningful.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
