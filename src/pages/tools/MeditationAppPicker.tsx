      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Yes. Hundreds of studies show 10-15 minutes of daily meditation lowers blood pressure, improves sleep, reduces pain, and helps with mild anxiety. The American Heart Association formally recommends meditation as a way to lower stress and BP.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mt-6">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">If you've never tried meditation:</p>
