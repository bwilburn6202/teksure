    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Use cases</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Birthday cards</li><li>Family newsletters</li><li>Holiday invitations</li><li>Garage sale posters</li><li>Family reunion announcements</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Canva is the free Photoshop. 80% of design needs covered.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
