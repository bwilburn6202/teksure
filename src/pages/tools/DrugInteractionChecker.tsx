      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">After 65, many adults take 5-10+ medications. Studies show 1 in 5 take a combination that causes a real interaction. Some are mild, some can cause falls, bleeding, or worse.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Your pharmacist is a real medication expert. CVS, Walgreens, Walmart, Costco — all offer FREE consultations. Walk in with a complete list of every medication, supplement, and over-the-counter drug you take. Ask: "Are any of these working against each other?"</p>
            <p className="text-base mt-2">Better still — use ONE pharmacy for all your prescriptions. Their system flags dangerous combinations automatically.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2 text-muted-foreground">If you take any of these, double-check with your pharmacist.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Once a year, ask your primary care doctor for a "deprescribing review". They look at every medication and ask: do you still need it? Studies show seniors safely come off 30-40% of their meds with this review. Less polypharmacy = fewer falls, less confusion.</p>
          </CardContent>
        </Card>
