      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">$10,000 sitting in Bank of America savings = $1/year (0.01% APY). Same $10,000 in Ally Bank = $420/year. Most people leave $300-500/year on the table because they&apos;ve never moved their savings.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Don&apos;t move your CHECKING — keep that at your local bank. HYSA is just for savings. Transfers between them take 1-3 days. Set up auto-transfer monthly to "save without thinking".</p>
          </CardContent>
        </Card>
