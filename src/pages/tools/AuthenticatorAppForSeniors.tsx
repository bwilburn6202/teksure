  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Why use one</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>SMS codes can be stolen.</li><li>Authenticator app safer.</li><li>Free.</li><li>Codes change every 30 sec.</li><li>Hacker-resistant.</li><li>Banks recommend.</li></ul></CardContent></Card>
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Best apps</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>Google Authenticator — free.</li><li>Microsoft Authenticator — free.</li><li>Authy — free, syncs devices.</li><li>1Password (paid).</li><li>iPhone built-in (Passwords).</li><li>Pick one.</li></ul></CardContent></Card>
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Setup at site</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>Login site security.</li><li>2-Factor → Authenticator app.</li><li>Scan QR code with app.</li><li>Enter 6-digit code.</li><li>Done — protected.</li><li>Save backup codes.</li></ul></CardContent></Card>
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Daily use</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>Login to site.</li><li>Open authenticator app.</li><li>Find that site.</li><li>Type 6-digit code.</li><li>Codes change every 30 sec.</li><li>Quick once habit.</li></ul></CardContent></Card>
        <Card className="mb-4"><CardContent className="pt-6"><h2 className="font-bold text-xl mb-3">Backup codes</h2><ul className="list-disc pl-5 space-y-2 text-base"><li>Print + save.</li><li>If you lose phone.</li><li>Recovery codes work once.</li><li>Senior file at home.</li><li>Don&apos;t lose them.</li><li>Hugely important.</li></ul></CardContent></Card>
