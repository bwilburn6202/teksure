      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Future generations care less about money inherited and more about WHO you were. Your stories — meeting your spouse, raising kids, the funny family vacation, what your parents were like — these are irreplaceable. StoryWorth makes it easy. Or do it yourself for free with Google Docs and a question list. Either way, start writing this year. Many adult children say their parent&apos;s memoir became their most treasured keepsake.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
