...
const tree: Record<string, Node> = {
  ...
  fix_slowMedium: {
    ...
    ifFails: 'If a cleanup and battery replacement don\'t give it new life, the phone is ready to retire. Trade-in value is still reasonable at this age.',
  ...
  fix_restartApp: {
    ...
    ifFails: 'If uninstall-and-reinstall doesn\'t help, the app is broken on your phone. Contact the app developer (their support email is in the App Store / Play Store listing) and use an alternative in the meantime.',
