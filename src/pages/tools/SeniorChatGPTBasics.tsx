    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">What it does</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Explains anything in plain English</li><li>Helps write letters or emails</li><li>Translates languages</li><li>Suggests recipes</li><li>Plans trips</li></ul></CardContent></Card>
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">SAFETY</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Never share Social Security number</li><li>Never share passwords or bank info</li><li>Don&apos;t trust medical advice — call your doctor</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Ask &ldquo;Explain like I&apos;m 70&rdquo; for clearer, slower answers without jargon.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
