    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Simple at home</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Stand on one leg (with chair backup)</li><li>Heel-to-toe walking</li><li>Sit-to-stand 10 times</li><li>Tightrope walk along line</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Practice near sturdy chair. Use it for support if needed.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
