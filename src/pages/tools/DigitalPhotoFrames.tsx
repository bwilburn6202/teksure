      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
            ...
            <Card key={f.name}>
              <CardContent className="pt-6">
                <div className="flex justify-between items-baseline mb-1">
                  ...
                  <span className="text-base font-semibold text-primary">{f.cost}</span>
                </div>
                <p className="text-base">{f.best}</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Set up the frame BEFORE giving it. Add 100 photos already loaded. Pre-connect to recipient&apos;s wifi (you&apos;ll need their wifi password). Tape a card to back with: "How to receive new photos: family emails them to frame@xxx.com." Saves the recipient any setup pain.</p>
          </CardContent>
        </Card>
