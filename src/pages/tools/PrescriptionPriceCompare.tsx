      ...
      <div className="max-w-2xl mx-auto px-4 py-8 print:p-4">
        <div className="mb-6 print:hidden">
          <div className="flex items-center gap-2 mb-1">
            <Pill className="h-7 w-7 text-danger-foreground" />
            <h1 className="text-3xl font-bold text-foreground">Prescription Price Compare</h1>
          </div>
          <p className="text-muted-foreground text-lg">The same pill can cost five times more at one pharmacy than another. Type the prices you can find and see which is cheapest.</p>
        </div>
        ...
        <Card className="mb-4 print:hidden">
          <CardContent className="py-4 px-4 space-y-3">
            ...
            <div>
              ...
              <select value={supply} onChange={e => setSupply(e.target.value)} className="w-full mt-1 border border-border rounded-md px-3 py-2 text-base bg-card">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">From your most recent receipt or your plan benefits booklet</p>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Costco sells to non-members. Search the drug at costco.com/pharmacy</p>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Look up at goodrx.com. Show the coupon at any pharmacy</p>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Call your pharmacy and ask: what is the cash price for {drug || "this drug"}?</p>
        ...
        {sorted.length > 0 && (
          <Card className="mb-4 border-success-foreground/25 border-2 bg-success">
            <CardContent className="py-4 px-4">
              <p className="text-base text-success-foreground">Cheapest option for {drug || "this drug"} ({supply}-day supply):</p>
              <p className="text-2xl font-bold text-success-foreground mt-1">{cheapest.label}</p>
              <p className="text-3xl font-bold text-success-foreground">{fmt(num(cheapest.amount))}</p>
              {savings > 0 && (
                <p className="text-base text-success-foreground mt-2">You save up to <span className="font-bold">{fmt(savings)}</span> vs the most expensive option.</p>
              )}
            </CardContent>
          </Card>
        )}
        ...
        <Card className="bg-warn border-warn-foreground/25 mb-4">
          <CardContent className="py-3 px-4">
