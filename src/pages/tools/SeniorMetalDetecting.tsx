    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Where to detect</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Parks (check rules)</li><li>Beaches</li><li>Old building sites</li><li>Friends&apos; properties</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Metal detecting = walking + treasure hunt. Best senior hobby.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
