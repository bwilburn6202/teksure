      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Your local bank pays 0.01-0.10% on savings. Online banks pay 4-5% — same FDIC insurance, same instant access. On $50,000 in savings, the difference is about $2,000/year. Pure profit for moving once.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3">All FDIC-insured up to $250,000. Same protection as Bank of America.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Lock money for a fixed time, get higher rate. Often 4.5-5.5% for 6-12 month CDs. Same online banks above offer them.</p>
            <p className="text-base">Penalty for early withdrawal — usually 3-6 months interest. Use only money you don\'t need access to.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Government bonds that protect against inflation. Currently paying about 4-5%. Tax-deferred federally, tax-free for state.</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">If you have a brokerage account (Vanguard, Fidelity, Schwab) — keep cash in a money market fund. Currently paying 4.5-5%. Different from FDIC-insured savings, but extremely safe and pays a great rate.</p>
            <p className="text-base mt-2">Examples: VMFXX (Vanguard), SPRXX (Fidelity), SWVXX (Schwab).</p>
          </CardContent>
        </Card>
