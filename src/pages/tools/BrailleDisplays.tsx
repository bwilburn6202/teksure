      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">A braille display is a small device with raised pins that pop up to form braille. Pairs with iPhone, iPad, Mac, or PC over Bluetooth. Read texts, emails, web pages — anything on the screen — in braille.</p>
          </CardContent>
        </Card>
