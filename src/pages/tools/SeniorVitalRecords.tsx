    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Common needs</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Real ID requires birth certificate</li><li>Pension claims</li><li>Estate planning</li><li>Spouse death claims</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Always start at YourState.gov vital records. Avoid fee scammers.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
