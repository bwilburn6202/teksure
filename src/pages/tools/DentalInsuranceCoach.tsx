      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Most Medicare Advantage plans now include dental coverage. Coverage varies WIDELY:</p>
            ...
            <p className="text-base mt-2">When picking a Medicare Advantage plan during Open Enrollment (Oct 15-Dec 7), compare dental coverage carefully.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2 text-muted-foreground">Most have 6-12 month waiting period for major work. Plan ahead.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">$10-15/month for "membership" giving 15-50% off at participating dentists. No waiting period, no annual max. Examples:</p>
            ...
            <p className="text-base mt-2">Best if you only need cleanings and routine work. Often cheaper than insurance.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Dental students under supervision do work at 30-50% less. Slower visits, but solid quality. 65 dental schools in the US — most have public clinics. Search "[your area] dental school clinic".</p>
          </CardContent>
        </Card>
