      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">After a fire or burglary, insurance companies ask: "What did you own and what was it worth?" With no inventory, you\'ll forget half. People who keep an inventory typically recover 30-50% MORE on claims than those who don\'t.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3">10-15 minute video covers a typical house. Insurance adjusters love this — it\'s self-evident proof.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2">Standard homeowner\'s insurance often caps jewelry at $1,500. If you have more than that, ask your agent about a "scheduled" rider.</p>
          </CardContent>
        </Card>
