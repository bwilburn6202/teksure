      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">The IRS\'s own free filing tool. Available in 25 states (and growing). Best for W-2 employees, retirees on Social Security, and simple returns.</p>
            ...
            <p className="text-base mt-2">Check if your state qualifies at <a href="https://directfile.irs.gov" target="_blank" rel="noopener noreferrer" className="text-primary underline">directfile.irs.gov</a>.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">A real human volunteer prepares your taxes for free. Designed for taxpayers 50+, but anyone can use it.</p>
            <ul className="list-disc pl-5 space-y-1 text-base">
            ...
            <p className="text-base mt-2">Find a location at <a href="https://www.aarp.org/money/taxes/aarp_taxaide/" target="_blank" rel="noopener noreferrer" className="text-primary underline">aarp.org/money/taxes/aarp_taxaide</a> or call 1-888-AARPNOW.</p>
            <p className="text-base mt-2 bg-muted/50 p-3 rounded"><strong>Most overlooked benefit for seniors.</strong> These volunteers are great. They catch things software misses.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Same idea as Tax-Aide but for taxpayers earning less than ~$60,000. IRS-trained volunteers.</p>
            <p className="text-base mt-2">Find a site at <strong>irs.gov/volunteers</strong> or call 211.</p>
          </CardContent>
        </Card>
