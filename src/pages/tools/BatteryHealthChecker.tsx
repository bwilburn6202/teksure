        ...
        {phone === 'android' && (
          <Card className="mb-4">
            <CardContent className="pt-6">
              ...
              <p className="text-base mb-3">Android doesn't show a single number like iPhone, but here's how to estimate:</p>
            ...
            <CardContent className="pt-6">
              ...
              {verdict.level !== 'good' && (
                <div className="mt-4 pt-4 border-t text-sm space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">Tip: Replacing the battery is much cheaper than buying a new phone — and most phones feel brand new again.</p>
                </div>
              )}
            </CardContent>
          </Card>
