    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Documents to gather</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>SSA-1099 (Social Security)</li><li>1099-R (pensions)</li><li>1099-DIV/INT (investments)</li><li>Property tax records</li><li>Medical expenses</li></ul></CardContent></Card>
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: AARP Tax-Aide is the best deal — free expert help, no income limit.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
