      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">After you turn <strong>73</strong> (under current law), the IRS requires you to start taking money out of your traditional 401(k), traditional IRA, 403(b), and similar retirement accounts every year. They want their tax money. The amount is calculated based on your age and account balance.</p>
            <p className="text-base mt-2"><strong>Roth IRAs are exempt</strong> while you're alive. Roth 401(k)s used to require RMDs but no longer (as of 2024).</p>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-base">Used to be 50%. Now <strong>25%</strong> of the missed amount (and only 10% if you fix it within 2 years). Still — costly. Set yourself a calendar reminder.</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Formula: Account balance on Dec 31 of the prior year ÷ a number from the IRS table based on your age.</p>
            <p className="text-base mb-2">Examples (using IRS Uniform Lifetime Table):</p>
            <ul className="list-disc pl-5 space-y-1 text-base">
            ...
            <p className="text-base mt-3">For example, $500,000 in a traditional IRA at age 73: $500,000 ÷ 26.5 = $18,868 RMD that year.</p>
          </CardContent>
        </Card>
