      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="font-semibold text-base mt-2">Make a FaceTime call:</p>
            ...
            <p className="font-semibold text-base">Make a WhatsApp call:</p>
            <ol className="list-decimal pl-5 space-y-1 text-base mb-3">
              <li>Open WhatsApp → find the contact.</li>
              <li>Tap the camera icon (top right) for video, phone icon for voice only.</li>
            </ol>
            <p className="font-semibold text-base">Join a Zoom call:</p>
