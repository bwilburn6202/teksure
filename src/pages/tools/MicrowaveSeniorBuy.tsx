      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground"><strong>Q: Replace every X years?</strong> Microwaves last 7-10 yrs. <strong>Q: Wattage matters?</strong> 700W slow, 1000W standard, 1100W+ best. <strong>Q: Worst brand?</strong> Anything under $80 generally. <strong>Q: Best deal?</strong> Costco bundles, holiday sales.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
