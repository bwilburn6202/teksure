      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Pays for help with daily activities (bathing, dressing, eating) when you can&apos;t do them yourself. In-home care, assisted living, nursing home, memory care. Original Medicare does NOT cover long-term care.</p>
          </CardContent>
        </Card>
