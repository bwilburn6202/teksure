    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Why useful</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Identify weeds before pulling</li><li>Find what grew unexpectedly</li><li>Diagnose sick plant problems</li><li>Avoid poisonous plants</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Take 3 photos: leaves, flowers, full plant. More angles = better accuracy.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
