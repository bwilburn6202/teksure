      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Lost / stolen / dropped-in-toilet phones happen weekly. WITHOUT backup = 30 years of photos GONE. Contacts gone. Notes gone. With backup = restore on new phone in 30 minutes.</p>
          </CardContent>
        </Card>
