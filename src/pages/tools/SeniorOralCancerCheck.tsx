    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Look for</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>White or red patches</li><li>Sores that don&apos;t heal</li><li>Lumps in mouth or neck</li><li>Persistent hoarseness</li><li>Difficulty swallowing</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Set monthly reminder. 5 minutes monthly is huge for early detection.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
