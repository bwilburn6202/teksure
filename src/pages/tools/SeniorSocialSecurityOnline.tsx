    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">What you can do</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>See your benefit amount</li><li>Get a 1099 for taxes</li><li>Change direct deposit</li><li>Update address</li><li>Get a benefit verification letter</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Print your annual statement every January for tax records.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
