      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4 bg-warn border-warn-foreground/25 ">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Even if your WILL says "everything to current spouse" — your IRA, 401k, life insurance, and "Pay on Death" bank accounts go to whoever&apos;s on the BENEFICIARY FORM. <strong>Beneficiary forms override your will.</strong> Ex-spouses, deceased people, and outdated names regularly inherit by mistake.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">If your primary beneficiary dies BEFORE you and you didn&apos;t name a contingent — money goes to your "estate" → probate → may go where you didn&apos;t want.</p>
            <p className="text-base mt-2">Always name backup. Common: spouse primary, kids equally as contingent.</p>
          </CardContent>
        </Card>
