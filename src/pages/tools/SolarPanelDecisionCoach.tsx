      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
          ...
          <CardContent className="pt-6">
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-base">Some are reputable, many are NOT. Use them only as a starting point. Always get 3 quotes from companies YOU find. (See our Door-to-Door Scam Defense.)</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2 text-muted-foreground">Push hard against lease/PPA unless you have NO other choice.</p>
          </CardContent>
        </Card>
