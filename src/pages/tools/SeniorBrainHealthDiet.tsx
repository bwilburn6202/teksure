    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Eat more</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Leafy greens (6+ servings/week)</li><li>Berries (2+ servings/week)</li><li>Nuts (5+ servings/week)</li><li>Olive oil (primary fat)</li><li>Fish (1+ servings/week)</li></ul></CardContent></Card>
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Eat less</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Red meat</li><li>Butter, margarine</li><li>Cheese (limit 1/week)</li><li>Sweets, pastries</li><li>Fried food</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Add berries to breakfast and spinach to dinner. Easy MIND start.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
