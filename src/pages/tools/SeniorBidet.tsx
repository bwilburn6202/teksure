    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Why for seniors</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Easier than wiping with arthritis</li><li>Better hygiene for incontinence</li><li>Saves toilet paper money</li><li>Reduces hemorrhoid issues</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Try $80 TUSHY first. If you love it, upgrade later.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
