      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Pick the same day &amp; time every week. Sunday 4 PM. Wednesday 7 PM. Whatever. Recurring beats "let&apos;s plan one" — that one rarely happens. Send a calendar invite to family. Auto-reminders.</p>
          </CardContent>
        </Card>
