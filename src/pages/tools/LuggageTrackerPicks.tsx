      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Wallet, keychain, car, bicycle, walker, the TV remote that always disappears. $29 each. Pays for itself the first time you find your keys before missing an appointment.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
