    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Top apps</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Honey (auto-applies coupons)</li><li>Rakuten (cash back)</li><li>Camelcamelcamel (Amazon prices)</li><li>Slickdeals (real deals)</li></ul></CardContent></Card>
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Watch out for</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Fake brand websites</li><li>&ldquo;Going out of business&rdquo; emails</li><li>Random gift card requests</li><li>Pressure-sale tactics</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: 20% senior discount on Tuesdays at Kohl&apos;s, Belk, others. Always ask.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
