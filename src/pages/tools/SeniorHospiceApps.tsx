    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">What it includes</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Nurse visits</li><li>Pain meds</li><li>Equipment</li><li>Counseling</li><li>Family bereavement support</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Hospice isn&apos;t giving up. It&apos;s comfort with dignity. Call sooner not later.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
