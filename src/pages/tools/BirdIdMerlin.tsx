      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">A free app from Cornell\'s Lab of Ornithology. It identifies birds three ways:</p>
            ...
            <p className="text-base mt-2">Many people who try the song-ID feature say it\'s the best free thing they\'ve installed in years.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="font-semibold text-base mt-2">Sound ID:</p>
            ...
            <p className="font-semibold text-base">Photo ID:</p>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">It\'s one of the world\'s top bird research institutions. Merlin lets normal people enjoy birds AND helps train the AI that powers their research. A win-win — you get to know your backyard birds, they get research data.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
