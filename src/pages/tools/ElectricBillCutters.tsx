      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Many utilities now offer time-of-use plans. Power costs less at night and on weekends. If you can run dishwasher/laundry off-peak, you save 15-30%.</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Most utility companies offer FREE home energy audits. They send a tech who finds drafts, checks insulation, recommends fixes. Often comes with free LED bulbs, smart thermostat rebates, and weatherstripping.</p>
            <p className="text-base mt-2">Search "[your utility name] free energy audit" or call customer service.</p>
          </CardContent>
        </Card>
