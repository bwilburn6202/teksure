        ...
        <section className="bg-gradient-to-br from-amber-50 via-background to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 border-b border-border py-10 px-4">
          <div className="container max-w-3xl mx-auto text-center">
            <div className="flex justify-center mb-3">
              <div className="p-3 bg-amber-500/10 rounded-full"><Dice5 className="h-8 w-8 text-warn-foreground" /></div>
            </div>
        ...
        <div className="container max-w-3xl mx-auto px-4 py-8">
          ...
          <Card className="border-border bg-muted/30 mb-6">
            <CardContent className="p-5">
              <p className="text-base font-semibold mb-2">Start with the free options</p>
          ...
          <Card className="border-border bg-muted/30">
            <CardContent className="p-5">
              <p className="text-base font-semibold mb-2">Pair it with a video call</p>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="mt-10 pt-8 border-t border-border">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              ...
              <Link to="/tools/video-call-etiquette" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                <p className="font-medium text-base">Video Call Etiquette</p>
                <p className="text-sm text-muted-foreground mt-0.5">Pair a call with the game.</p>
              </Link>
              <Link to="/tools/podcast-starter" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Listen to something between games.</p>
              </Link>
            </div>
          </div>
