      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Term coined by Marc Freedman. Career change in your 50s/60s/70s — often less pay but more purpose. Public service, teaching, nonprofit, advocacy. Studies show better health + longer life vs full retirement.</p>
          </CardContent>
        </Card>
