      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">No shame in this. Many wealthy seniors use it for safety check + nutritious meal. Family across country = peace of mind. Cooking for one is hard. Funded by Older Americans Act = your tax dollars. Use what&apos;s available.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
