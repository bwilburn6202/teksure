    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Turn iPhone sideways. Calculator gets way bigger.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
