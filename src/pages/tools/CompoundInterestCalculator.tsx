    ...
    <main className="min-h-screen bg-muted">
      ...
      <div className="max-w-xl mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground text-lg">See how money grows over time with compound interest.</p>
        </div>
        <Card>
          <CardContent className="py-6 px-4 space-y-3">
            ...
            {valid && (
              <div className="text-center bg-success border border-success-foreground/25 rounded-md py-4 px-3 space-y-2">
                <p className="text-base text-success-foreground">After {y} year{y !== 1 ? "s" : ""}</p>
                <p className="text-4xl font-bold text-success-foreground">{fmt(total)}</p>
                <div className="grid grid-cols-2 gap-3 mt-2 text-xs">
                  <div><p className="text-muted-foreground">You contributed</p><p className="font-semibold">{fmt(totalContributed)}</p></div>
                  <div><p className="text-muted-foreground">Interest earned</p><p className="font-semibold text-success-foreground">{fmt(totalInterest)}</p></div>
                </div>
              </div>
            )}
          </CardContent>
