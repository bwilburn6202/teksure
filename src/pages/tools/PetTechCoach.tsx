      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3 bg-muted/50 p-3 rounded"><strong>Quick Tip:</strong> Add an old-fashioned tag with your phone number too. AirTags fail. Phone numbers don't.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3"><strong>First time:</strong> Set up a 15-minute "meet and greet" before letting a stranger walk your dog. All real services support this.</p>
          </CardContent>
        </Card>
