      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3">Sounds silly. Works perfectly. No charging, no apps.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-3">Frozen food doesn&apos;t go bad — it loses quality. After the dates above it&apos;s safe but tastes worse.</p>
          </CardContent>
        </Card>
