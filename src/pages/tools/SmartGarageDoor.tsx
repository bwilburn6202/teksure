        ...
        <div className="container max-w-3xl mx-auto px-4 py-8">
          ...
          <Card className="border-border bg-muted/30 mb-6">
            <CardContent className="p-5">
              <p className="text-base font-semibold mb-2">Why bother making the garage smart?</p>
            ...
            {(showAll ? OPENERS : OPENERS.slice(0, 3)).map(o => (
              <Card key={o.name} className="border-border">
                <CardContent className="p-5">
                  ...
                  <p className="text-base text-muted-foreground mb-2"><strong>Best for:</strong> {o.whoFor}</p>
                  <p className="text-sm text-muted-foreground mb-1"><strong>Install:</strong> {o.install}</p>
                  <p className="text-sm text-muted-foreground mb-3"><strong>App:</strong> {o.app}</p>
          ...
          <Card className="border-border bg-muted/30 mb-6">
            <CardContent className="p-5">
              <p className="text-base font-semibold mb-2">A senior-friendly setup — automate one thing</p>
              <p className="text-sm text-muted-foreground mb-2">
          ...
          <Card className="border-border bg-muted/30">
            <CardContent className="p-5">
              <p className="text-base font-semibold mb-2">Worth knowing about install</p>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="mt-10 pt-8 border-t border-border">
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              <Link to="/tools/smart-home-starter" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Pick your first smart device.</p>
              </Link>
              <Link to="/tools/smart-lock-picker" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                ...
                <p className="text-sm text-muted-foreground mt-0.5">A natural pair with a smart garage.</p>
              </Link>
              <Link to="/tools/video-doorbell-picker" className="p-3 rounded-lg border border-border hover:border-primary/50 hover:bg-primary/5 transition-all">
                <p className="font-medium text-base">Video Doorbell Picker</p>
                <p className="text-sm text-muted-foreground mt-0.5">See who is at the door, too.</p>
              </Link>
            </div>
          </div>
