      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Only about 48% of eligible adults 60+ actually use SNAP. Many feel embarrassed to apply. Many don\'t know they\'d qualify. The average senior gets $179/month in benefits. Free money for groceries.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-2">Special senior rules — easier than for younger adults:</p>
            ...
            <p className="text-base mt-2">Even if you think you don\'t qualify — APPLY. The medical deduction lifts many seniors over the line.</p>
          </CardContent>
        </Card>
