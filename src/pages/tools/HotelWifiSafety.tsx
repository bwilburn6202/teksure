      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-6 bg-primary/5 border-primary/20">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Public Wi-Fi (hotels, airports, coffee shops) is often shared with hundreds of strangers. Crooks can set up fake networks named "Hotel-Free-WiFi" to trick you into joining them. Once joined, they can sometimes see what you type — including bank logins.</p>
          </CardContent>
        </Card>
