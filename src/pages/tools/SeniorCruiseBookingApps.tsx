    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Top senior lines</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Holland America (older crowd)</li><li>Princess (relaxed)</li><li>Viking (no kids, all-inclusive)</li><li>Royal Caribbean (more activity)</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Inside cabins are 50% cheaper than balconies. Most time spent off-cabin anyway.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
