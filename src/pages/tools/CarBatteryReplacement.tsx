      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Trunk: jumper cables (or jumper pack), reflective triangle, blanket, water, granola bars, phone charger, flashlight, basic tools, AAA card. Replace battery preventively at year 4. Don&apos;t get stranded.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
