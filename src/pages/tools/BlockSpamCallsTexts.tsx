      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-3">All three big carriers have free apps that block known robocallers BEFORE the phone rings.</p>
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mb-3">Free, lifetime, federal. Doesn't stop scammers (they break the law anyway), but stops most legitimate telemarketers.</p>
            ...
            <p className="text-base mt-3">After signing up, telemarketers must stop within 31 days. Report violators on the same site.</p>
          </CardContent>
        </Card>
