      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">Apple Watch lasts 1-2 days. Charge nightly (or while showering) — habit forms in a week. Never run out. Series 10 charges to 80% in 30 min.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
