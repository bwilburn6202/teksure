      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">"CAPS" = Certified Aging-in-Place Specialist. Trained for senior modifications. Find at NAHB.org. Often costs same as regular contractor + actually understands senior needs.</p>
          </CardContent>
        </Card>
