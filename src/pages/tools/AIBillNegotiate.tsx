      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base">Tell AI: "Write me a script to negotiate my cable bill down. Current bill $180/mo. I&apos;ve been customer 8 years. New customer rate is $99/mo. Goal: match new customer rate."</p>
            <p className="text-base mt-2">AI generates word-for-word script. You read it on the call. They reduce bill.</p>
          </CardContent>
        </Card>
