    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Best picks</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Amazon Smart Plug — $24, easiest with Alexa</li><li>Wyze Plug — $15 for 2-pack</li><li>TP-Link Kasa — $20, very reliable</li></ul></CardContent></Card>
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Senior uses</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>Coffee pot starts at 6 AM</li><li>Fan turns off at bedtime</li><li>Holiday lights on at sunset</li><li>Heating pad shuts off after 30 min</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Name plugs clearly: &ldquo;Living Room Lamp&rdquo; not &ldquo;Plug 1.&rdquo;</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
