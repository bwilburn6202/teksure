    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div className="space-y-4">
          ...
          <Card><CardContent className="pt-6"><h2 className="font-semibold mb-2">Pre-written messages</h2><ul className="list-disc pl-5 space-y-1 text-base"><li>I&apos;m at the hospital</li><li>Power outage. I&apos;m fine</li><li>Need help. Please call.</li></ul></CardContent></Card>
          ...
          <Card className="bg-muted/40"><CardContent className="pt-6"><p className="text-base">Quick Tip: Apple Check-In = automatic status to family without effort.</p></CardContent></Card>
        </div>
      </main>
      <Footer />
    </div>
