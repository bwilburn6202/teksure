      ...
      <main className="flex-1 container mx-auto px-4 py-10 max-w-3xl">
        ...
        <Card className="mb-4">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2 text-muted-foreground">Buy these from low-cost insurers via fee-only advisors — Schwab, Fidelity, Vanguard, or Stan Haithcock\'s "annuityman.com".</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-4 border-destructive">
          <CardContent className="pt-6">
            ...
            <p className="text-base mt-2"><strong>Hallmarks of a bad annuity</strong>: long surrender period (5-10 years), commission to seller of 5-10% of your investment, multiple "riders" with extra fees, complex math you can\'t explain back.</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/40">
          <CardContent className="pt-6">
            ...
            <p className="text-base text-muted-foreground">If you want guaranteed income — SPIA from a top-rated insurer. If you want growth + safety — index funds + bond ladder, NOT a complex annuity. Always get a 2nd opinion from a fee-only fiduciary BEFORE signing.</p>
          </CardContent>
        </Card>
      </main>
      <Footer />
