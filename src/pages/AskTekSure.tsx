    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-orange-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <main id="main-content" className="container mx-auto px-4 py-16 md:py-24">
        ...
        <section className="max-w-4xl mx-auto text-center mb-20">
          ...
          <h1
            className="font-bold tracking-tight text-foreground dark:text-white mb-6 leading-tight"
            style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)' }}
          >
            Got a Tech Question?
            <br />
            <span className="text-warn-foreground ">We've Got Answers.</span>
          </h1>
        ...
        <section className="max-w-6xl mx-auto mb-24">
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {/* Option 1 */}
            <Card className="border-2 border-warn-foreground/25 bg-card hover:shadow-xl transition-shadow">
              <CardContent className="p-8 flex flex-col h-full">
                <div className="text-5xl mb-4"></div>
                <Badge className="w-fit mb-3 bg-success text-success-foreground ">
                  Fastest
                </Badge>
            ...
            {/* Option 2 */}
            <Card className="border-2 border-info-foreground/25 bg-card hover:shadow-xl transition-shadow">
              <CardContent className="p-8 flex flex-col h-full">
                <div className="text-5xl mb-4"></div>
                <Badge className="w-fit mb-3 bg-info text-info-foreground ">
                  Community
                </Badge>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground dark:text-white mb-3">
                ...
                <Button asChild size="lg" variant="outline" className="text-lg py-6 border-2 border-blue-600 text-info-foreground dark:border-blue-500 hover:bg-info ">
                  <Link to="/forum">
            ...
            {/* Option 3 */}
            <Card className="border-2 border-danger-foreground/25 bg-card hover:shadow-xl transition-shadow">
              <CardContent className="p-8 flex flex-col h-full">
                <div className="text-5xl mb-4"></div>
                <Badge className="w-fit mb-3 bg-danger text-danger-foreground ">
                  One-on-one
                </Badge>
                <h2 className="text-2xl md:text-3xl font-bold text-foreground dark:text-white mb-3">
                  Get Real Help
                ...
                <Button asChild size="lg" variant="outline" className="text-lg py-6 border-2 border-rose-600 text-danger-foreground dark:border-rose-500 hover:bg-danger ">
                  <Link to="/get-help">
        ...
        <section className="max-w-4xl mx-auto mb-24">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-foreground dark:text-white mb-4">
              ...
              <Link key={text} to={href} className="group">
                <Card className="h-full hover:shadow-lg hover:border-amber-400 dark:hover:border-amber-600 transition-all">
                  <CardContent className="p-6 flex items-center gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-warn flex items-center justify-center">
                      <Icon className="w-6 h-6 text-warn-foreground " />
                    </div>
                    <p className="text-lg font-medium text-foreground flex-grow">
                      "{text}"
                    </p>
                    <ArrowRight className="w-5 h-5 text-muted-foreground group-hover:text-warn-foreground group-hover:translate-x-1 transition-all" />
                  </CardContent>
                </Card>
              </Link>
            ))}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {POPULAR_QUESTIONS.map(({ question, href, emoji }) => (
              <Link key={question} to={href} className="group">
                <Card className="h-full hover:shadow-lg hover:-translate-y-1 transition-all border-border ">
                  <CardContent className="p-6 flex flex-col h-full">
                    <div className="text-3xl mb-3">{emoji}</div>
                    <p className="text-base font-medium text-foreground flex-grow leading-snug">
                      {question}
                    </p>
                    <div className="mt-4 flex items-center text-sm text-warn-foreground font-semibold">
                      Read guide
        ...
        <section className="max-w-3xl mx-auto">
          <Card className="bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-950/40 dark:to-orange-950/40 border-warn-foreground/25 ">
