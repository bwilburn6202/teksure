...
const TOPIC_PHOTOS: Array<{ keywords: string[]; photoId: string }> = [
  ...
  { keywords: ['ipad', 'ipados'], photoId: '1557660559-42497f76350d' },
  ...
  { keywords: ['airpods'], photoId: '1588156979435-379b9d802b0a' },
  ...
  { keywords: ['copilot', 'microsoft-ai'], photoId: '1692607431995-a2c40d1a1ad5' },
  { keywords: ['perplexity'], photoId: '1686191128892-a2c040e8f3be' },
  ...
  { keywords: ['smart-home', 'alexa', 'google-home', 'nest', 'ecobee', 'thermostat'], photoId: '1558002038-bb4237b54d6c' },
  { keywords: ['smart-speaker', 'echo-show', 'home-mini', 'voice-assistant'], photoId: '1558089687-db9280020006' },
  { keywords: ['ring-doorbell', 'security-camera', 'home-security', 'simplisafe', 'arlo', 'blink'], photoId: '1558002038-b1a5c7a0d48e' },
  { keywords: ['robot-vacuum', 'roomba', 'shark-robot'], photoId: '1595750223148-65ed0c8c2c5d' },
  { keywords: ['smart-bulb', 'smart-light', 'hue', 'lifx', 'kasa', 'govee'], photoId: '1558000143-a78f8299c40b' },
  { keywords: ['ev', 'electric-vehicle', 'charging', 'chargepoint', 'electrify-america', 'evgo'], photoId: '1593941707882-a5bac6861d75' },
  ...
  { keywords: ['keyboard', 'mouse', 'trackpad', 'shortcuts'], photoId: '1561040029-78568f35c65d' },
  ...
  { keywords: ['battery', 'power-bank', 'fast-charging', 'charging'], photoId: '1609592424823-6da42b06b7b0' },
  { keywords: ['ai-image-gen', 'dalle', 'dall-e', 'midjourney', 'stable-diffusion'], photoId: '1684369175809-f9642140a1bf' },
  ...
  { keywords: ['qr-code', 'barcode', 'scan-code'], photoId: '1618005182384-a83a8bd57fce' },
  ...
  { keywords: ['weather', 'storm', 'hurricane', 'tornado'], photoId: '1504000728-e8b4ca0cfd7e' },
];
...
const CATEGORY_DEFAULTS: Record<string, string> = {
  ...
  'smart-home': '1558002038-bb4237b54d6c',
